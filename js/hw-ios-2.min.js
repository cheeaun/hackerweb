...
d.fl()},partials:{},subs:{}}),comments:new a({code:function(a,b,c){var d=this;return d.b(c=c||""),d.s(d.f("comments",a,b,1),a,b,0,13,327,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<li><p class="metadata '),c.s(c.f("deleted",a,b,1),a,b,0,48,55,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b("deleted")}),a.pop()),c.b('">'),c.s(c.f("deleted",a,b,1),a,b,0,81,103,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b("<span>[deleted]</span>")}),a.pop()),c.s(c.f("deleted",a,b,1),a,b,1,0,0,"")||(c.b('<b class="user">'),c.b(c.v(c.f("user",a,b,0))),
c.b("</b>")),c.b('<time><a href="#" data-id="'),c.b(c.v(c.f("id",a,b,0))),c.b('" class="comment-permalink">'),c.b(c.v(c.f("time_ago",a,b,0))),c.b("</a></time></p>"),c.s(c.f("deleted",a,b,1),a,b,1,0,0,"")||(c.b("<p>"),c.b(c.t(c.f("content",a,b,0)))),c.b("<ul>"),c.b(c.rp("<comments_list0",a,b,"")),c.b("</ul></li>")}),a.pop()),d.fl()},partials:{"<comments_list0":{name:"comments_list",partials:{},subs:{}}},subs:{}}),"post-comments":new a({code:function(a,b,c){var d=this;return d.b(c=c||""),d.b('<div class="post-content">'),
d.s(d.f("has_post",a,b,1),a,b,0,39,573,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<header><a href="'),c.b(c.v(c.f("url",a,b,0))),c.b('" target="_blank"><h1>'),c.b(c.v(c.f("title",a,b,0))),c.b("</h1>"),c.s(c.f("user",a,b,1),a,b,0,108,171,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.s(c.f("domain",a,b,1),a,b,0,119,160,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b('<span class="link-text">'),c.b(c.v(c.f("domain",a,b,0))),c.b("</span>")}),a.pop())}),a.pop()),c.b('</a><p class="metadata">'),c.s(c.f("user",a,b,1),a,b,0,213,408,"{{ }}")&&(c.rs(a,b,function(a,b,c){
c.b('<span class="inline-block">'),c.b(c.v(c.f("points",a,b,0))),c.b(" "),c.b(c.v(c.f("i_point",a,b,0))),c.b(" by "),c.b(c.v(c.f("user",a,b,0))),c.b('</span> <span class="inline-block">'),c.b(c.v(c.f("time_ago",a,b,0))),c.s(c.f("comments_count",a,b,1),a,b,0,340,382,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b(" &middot; "),c.b(c.v(c.f("comments_count",a,b,0))),c.b(" "),c.b(c.v(c.f("i_comment",a,b,0)))}),a.pop()),c.b("</span>")}),a.pop()),c.s(c.f("user",a,b,1),a,b,1,0,0,"")||(c.b('<span class="inline-block">'),
c.b(c.v(c.f("time_ago",a,b,0))),c.b("</span>")),c.b('<a href="'),c.b(c.v(c.f("hn_url",a,b,0))),c.b('" target="_blank" class="external-link">'),c.b(c.v(c.f("short_hn_url",a,b,0))),c.b("</a></p></header>")}),a.pop()),d.s(d.f("has_content",a,b,1),a,b,0,602,925,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<section class="grouped-tableview">'),c.b(c.t(c.f("content",a,b,0))),c.s(c.f("has_poll",a,b,1),a,b,0,663,902,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b('<ul class="poll">'),c.s(c.f("poll",a,b,1),a,b,0,689,888,"{{ }}")&&(c.rs(a,b,function(a,b,c){
...
c.b("detail-disclosure")}),a.pop()),d.s(d.f("disclosure",a,b,1),a,b,0,164,174,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b("disclosure")}),a.pop()),d.b(" "),d.s(d.f("selected",a,b,1),a,b,0,203,211,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b("selected")}),a.pop()),d.b('"><div class="number">'),d.b(d.v(d.f("i",a,b,0))),d.b('</div><div class="story"><b>'),d.b(d.v(d.f("title",a,b,0))),d.b("</b>"),d.s(d.f("user",a,b,1),a,b,0,301,593,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<span class="metadata">'),c.s(c.f("domain",a,b,1),a,b,0,335,380,"{{ }}")&&(c.rs(a,b,function(a,b,c){
c.b('<span class="link-text">'),c.b(c.v(c.f("domain",a,b,0))),c.b("</span><br>")}),a.pop()),c.b('<span class="inline-block">'),c.b(c.v(c.f("points",a,b,0))),c.b(" "),c.b(c.v(c.f("i_point",a,b,0))),c.b(" by "),c.b(c.v(c.f("user",a,b,0))),c.b('</span> <span class="inline-block">'),c.b(c.v(c.f("time_ago",a,b,0))),c.s(c.f("comments_count",a,b,1),a,b,0,518,560,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b(" &middot; "),c.b(c.v(c.f("comments_count",a,b,0))),c.b(" "),c.b(c.v(c.f("i_comment",a,b,0)))}),a.pop()),
c.b("</span></span>")}),a.pop()),d.s(d.f("user",a,b,1),a,b,1,0,0,"")||(d.b('<span class="metadata">'),d.s(d.f("domain",a,b,1),a,b,0,645,690,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<span class="link-text">'),c.b(c.v(c.f("domain",a,b,0))),c.b("</span><br>")}),a.pop()),d.b('<span class="inline-block">'),d.b(d.v(d.f("time_ago",a,b,0))),d.b("</span></span>")),d.b("</div></a>"),d.s(d.f("detail_disclosure",a,b,1),a,b,0,795,869,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<a href="#/item/'),c.b(c.v(c.f("id",a,b,0))),
c.b('" class="detail-disclosure-button"><span></span></a>')}),a.pop()),d.b("</li>"),d.fl()},partials:{},subs:{}}),"stories-load":new a({code:function(a,b,c){var d=this;return d.b(c=c||""),d.s(d.f("loading",a,b,1),a,b,0,12,82,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<div class="loader"><i class="icon-loading"></i> Loading&hellip;</div>')}),a.pop()),d.s(d.f("load_error",a,b,1),a,b,0,109,161,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<div class="load-error">Couldn\'t load stories.</div>')}),a.pop()),d.fl();
...
if(m){clearTimeout(q);var c=b.parentNode.parentNode;setTimeout(function(){c&&c.classList.remove("list-tapped")},100)}},onTap:function(b,c){c.classList.contains("more-link")?hw.news.more(c):/^#\//.test(c.getAttribute("href"))?location.hash=c.hash:c.href&&m&&a.open(c.href)}}),tappable("#view-about .grouped-tableview-links li>a:first-child",{allowClick:!0,activeClassDelay:100,inactiveClassDelay:1e3}),tappable("#view-home .tableview-links li>a.detail-disclosure-button",{noScroll:!0,noScrollDelay:100,
onTap:function(a,b){"comments"!=hw.currentView&&(location.hash=b.hash)}}),tappable("button.comments-toggle",function(a,b){hw.comments.toggle(b)}),tappable("#view-comments .load-error button",hw.comments.reload),hw.sub("selectCurrentStory",function(a){if(m){a||(a=(location.hash.match(/item\/(\d+)/)||[,""])[1]);for(var b=$("view-home"),c=b.querySelectorAll("a[href].selected"),d=0,e=c.length;e>d;d++)c[d].classList.remove("selected");if(a){var f=b.querySelector('a[href*="item/'+a+'"]');f&&(f.classList.add("selected"),
setTimeout(function(){f.scrollIntoViewIfNeeded?f.scrollIntoViewIfNeeded():f.scrollIntoView()},1))}}}),hw.sub("onRenderNews",function(){hw.pub("selectCurrentStory")}),a.addEventListener("pageshow",function(){setTimeout(function(){"home"==hw.currentView&&$("hwlist")&&!amplify.store("hacker-news-cached")&&hw.news.reload()},1)},!1),m){var r=$("apploader");r.parentNode.removeChild(r)}else setTimeout(function(){var a=$("apploader");a&&(a.classList.add("hide"),f(a,"TransitionEnd",function(){a.parentNode.removeChild(a);
}))},200);m&&setTimeout(function(){$("view-about").classList.add("animated")},400),hw.news.options.disclosure=!m,hw.init()}(window),WebFontConfig={google:{families:["Inconsolata"]}},function(){var a=document.createElement("script");a.src=("https:"==document.location.protocol?"https":"http")+"://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js",a.type="text/javascript",a.async="true";var b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(a,b)}();
