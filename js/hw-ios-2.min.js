...
,"$1"))}function N(e,t){for(var n,o,i,r=!1;n=e,o=t,!(r=((i=L.documentElement).matchesSelector||i.mozMatchesSelector||i.webkitMatchesSelector||i.oMatchesSelector||i.msMatchesSelector).call(n,o))&&(e=e.parentNode)&&e.ownerDocument;);return!!r&&e}var C=Math.abs,A={noScroll:!1,activeClass:"tappable-active",onTap:t,onStart:t,onMove:t,onMoveOut:t,onMoveIn:t,onEnd:t,onCancel:t,allowClick:!1,boundMargin:50,noScrollDelay:0,activeClassDelay:0,inactiveClassDelay:0},o="ontouchend"in document,q={
...
e.hw=T,ruto.config({before:function(e,t){T.hideAllViews();var n=f("view-"+t);n.classList.remove("hidden"),T.currentView=t,T.setTitle(n.querySelector("header h1").textContent)},notfound:function(){ruto.go("/")}}).add("/","home").add("/about","about").add(/^\/item\/(\d+)$/i,"comments",function(e,t){T.comments.render(t)})}(window),function(n){function l(e,t,n){for(var o=0;o<a;o++)i[o]||(t=t.toLowerCase()),e.addEventListener(i[o]+t,n,!1)}function c(e,t,n){for(var o=0;o<a;o++)i[o]||(t=t.toLowerCase()
),e.removeEventListener(i[o]+t,n,!1)}function u(e){var t=e.in,n=e.out,o=t.classList,i=n.classList,r=e.direction,a=d[r],s=function(){i.add("hidden"),i.remove(a[0]),o.remove(a[1]),c(t,"AnimationEnd",s)};l(t,"AnimationEnd",s),o.remove("hidden"),o.add(a[1]),i.add(a[0])}function f(e){var t,n=e.in,o=e.out,i=n.classList,r=o.classList;"up"==e.direction?(r.add("no-pointer"),i.remove("hidden"),i.add("slide-up")):(l(o,"AnimationEnd",t=function(){r.remove("slide-down"),r.add("hidden"),i.remove("no-pointer")
,c(o,"AnimationEnd",t)}),r.remove("slide-up"),r.add("slide-down"))}function t(){return 736<(e.offsetWidth||n.innerWidth)?"wide":"narrow"}var r=n.document,e=r.body,i=["webkit","moz","MS","o",""],a=i.length,d={rtl:["slide-out-to-left","slide-in-from-right"],ltr:["slide-out-to-right","slide-in-from-left"]},o=r.querySelector("meta[name=viewport]");o||((o=r.createElement("meta")).name="viewport",r.head.appendChild(o)),
...
onMove:function(){p&&clearTimeout(h)},onEnd:function(e,t){var n;p&&(clearTimeout(h),n=t.parentNode.parentNode,setTimeout(function(){n&&n.classList.remove("list-tapped")},100))},onTap:function(e,t){t.classList.contains("more-link")?hw.news.more(t):/^#\//.test(t.getAttribute("href"))?location.hash=t.hash:t.href&&p&&n.open(t.href)}}),tappable("#view-about .grouped-tableview-links li>a:first-child",{allowClick:!0,activeClassDelay:100,inactiveClassDelay:1e3}),tappable(
"#view-home .tableview-links li>a.detail-disclosure-button",{noScroll:!0,noScrollDelay:100,onTap:function(e,t){"comments"!=hw.currentView&&(location.hash=t.hash)}}),tappable("button.comments-toggle",function(e,t){hw.comments.toggle(t)}),tappable("#view-comments .load-error button",hw.comments.reload),hw.sub("selectCurrentStory",function(e){if(p){e=e||(location.hash.match(/item\/(\d+)/)||[,""])[1];for(var t,n=$("view-home"),o=n.querySelectorAll("a[href].selected"),i=0,r=o.length;i<r;i++
)o[i].classList.remove("selected");!e||(t=n.querySelector('a[href*="item/'+e+'"]'))&&(t.classList.add("selected"),setTimeout(function(){t.scrollIntoViewIfNeeded?t.scrollIntoViewIfNeeded():t.scrollIntoView()},1))}}),hw.sub("onRenderNews",function(){hw.pub("selectCurrentStory")}),n.addEventListener("pageshow",function(){setTimeout(function(){"home"==hw.currentView&&$("hwlist")&&!amplify.store("hacker-news-cached")&&hw.news.reload()},1)},!1),p&&setTimeout(function(){$("view-about").classList.add(
"animated")},400),hw.news.options.disclosure=!p,hw.init()}(window);
