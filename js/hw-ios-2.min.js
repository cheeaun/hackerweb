...
,"$1"))}function N(e,t){for(var n,o,i,r=!1;n=e,o=t,i=void 0,!(r=((i=L.documentElement).matchesSelector||i.mozMatchesSelector||i.webkitMatchesSelector||i.oMatchesSelector||i.msMatchesSelector).call(n,o))&&(e=e.parentNode)&&e.ownerDocument;);return!!r&&e}var A=Math.abs,C={noScroll:!1,activeClass:"tappable-active",onTap:t,onStart:t,onMove:t,onMoveOut:t,onMoveIn:t,onEnd:t,onCancel:t,allowClick:!1,boundMargin:50,noScrollDelay:0,activeClassDelay:0,inactiveClassDelay:0},o="ontouchend"in document,q={
start:o?"touchstart":"mousedown",move:o?"touchmove":"mousemove",end:o?"touchend":"mouseup"};e.tappable=function(o,e){"function"==typeof e&&(e={onTap:e});var r={};for(var t in C)r[t]=e[t]||C[t];function n(e){var t,n=N(function(e){var t=e.target;if(t)return 3==t.nodeType&&(t=t.parentNode),t;var n=e.targetTouches[0];return M(n.clientX,n.clientY)}(e),o);n&&(T?(clearTimeout(m),m=setTimeout(function(){x(n,g)},T)):x(n,g),E&&n==u&&clearTimeout(h),d=e.clientX,f=e.clientY,d&&f||(t=e.targetTouches[0],
d=t.clientX,f=t.clientY),c=n,y=w=!1,p=S?n.getBoundingClientRect():null,k&&(clearTimeout(v),S=!1,v=setTimeout(function(){S=!0},k)),r.onStart.call(b,e,n))}function i(e){var t,n,o,i;c&&(S?e.preventDefault():clearTimeout(m),i=e.target,n=e.clientX,o=e.clientY,i&&n&&o||(t=e.changedTouches[0],n=n||t.clientX,o=o||t.clientY,i=i||M(n,o)),S?n>p.left-_&&n<p.right+_&&o>p.top-_&&o<p.bottom+_?(y=!1,x(c,g),r.onMoveIn.call(b,e,i)):(y=!0,I(c,g),r.onMoveOut.call(b,e,i)):!w&&10<A(o-f)&&(w=!0,I(c,g),r.onCancel.call(
i,e)),r.onMove.call(b,e,i))}function a(e){var t,n;c&&(clearTimeout(m),E?(T&&!w&&x(c,g),t=c,h=setTimeout(function(){I(t,g)},E)):I(c,g),r.onEnd.call(b,e,c),n=3==e.which||2==e.button,w||y||n||r.onTap.call(b,e,c),u=c,c=null,setTimeout(function(){d=f=null},400))}function s(e){c&&(I(c,g),c=d=f=null,r.onCancel.call(b,e))}function l(e){N(e.target,o)?e.preventDefault():d&&f&&A(e.clientX-d)<25&&A(e.clientY-f)<25&&(e.stopPropagation(),e.preventDefault())}var c,u,d,f,p,m,h,v,b=r.containerElement||L.body,
...
c[u].target="_blank"}var f=n.user;if(f)for(var p=l.querySelectorAll(".user"),u=0,d=p.length;u<d;u++){var m=p[u];m.textContent.trim()==f&&(m.classList.add("op"),m.title="Original Poster")}if(2e4<s.length)for(var h=l.querySelectorAll(".comments>ul>li>ul"),v=E("comments-toggle"),b=0,d=h.length;b<d;b++){var w=h[b],y=w.querySelectorAll(".metadata").length;w.style.display="none",y&&w.insertAdjacentHTML("beforebegin",v.render({comments_count:y,i_reply:1==y?"reply":"replies"}))}for(;_.hasChildNodes();
