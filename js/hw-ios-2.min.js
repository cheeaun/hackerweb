...
),e.removeEventListener(i[o]+t,n,!1)}function u(e){var t=e.in,n=e.out,o=t.classList,i=n.classList,r=e.direction,a=f[r],s=function(){i.add("hidden"),i.remove(a[0]),o.remove(a[1]),c(t,"AnimationEnd",s)};l(t,"AnimationEnd",s),o.remove("hidden"),o.add(a[1]),i.add(a[0])}function d(e){var t,n=e.in,o=e.out,i=n.classList,r=o.classList;"up"==e.direction?(r.add("no-pointer"),i.remove("hidden"),i.add("slide-up")):(l(o,"AnimationEnd",t=function(){r.remove("slide-down"),r.add("hidden"),i.remove("no-pointer")
,c(o,"AnimationEnd",t)}),r.remove("slide-up"),r.add("slide-down"))}function t(){return 736<(e.offsetWidth||n.innerWidth)?"wide":"narrow"}var r=n.document,e=r.body,i=["webkit","moz","MS","o",""],a=i.length,f={rtl:["slide-out-to-left","slide-in-from-right"],ltr:["slide-out-to-right","slide-in-from-left"]},o=r.querySelector("meta[name=viewport]");o||((o=r.createElement("meta")).name="viewport",r.head.appendChild(o)),
...
noScroll:!0,onTap:function(e,t){var n=t.hash;p&&/about/i.test(ruto.current)&&"#/"==n?ruto.back("/"):location.hash=n}}),tappable("#view-home-refresh",{noScroll:!0,onTap:hw.news.reload});var h,v,b=!1;tappable(".view>header h1",{onTap:function(e,t){var o,i=t.parentNode.nextElementSibling.firstElementChild;0==i.scrollTop||b||b||(b=!0,o=i.style.overflow,i.style.overflow="hidden",setTimeout(function(){i.style.overflow=o;var e=new TWEEN.Tween({scrollTop:i.scrollTop}).to({scrollTop:0},300).easing(
...
)o[i].classList.remove("selected");!e||(t=n.querySelector('a[href*="item/'+e+'"]'))&&(t.classList.add("selected"),setTimeout(function(){t.scrollIntoViewIfNeeded?t.scrollIntoViewIfNeeded():t.scrollIntoView()},1))}}),hw.sub("onRenderNews",function(){hw.pub("selectCurrentStory")}),n.addEventListener("pageshow",function(){setTimeout(function(){"home"==hw.currentView&&$("hwlist")&&!amplify.store("hacker-news-cached")&&hw.news.reload()},1)},!1),p?(v=$("apploader")).parentNode.removeChild(v
):setTimeout(function(){var e=$("apploader");e&&(e.classList.add("hide"),l(e,"TransitionEnd",function(){e.parentNode.removeChild(e)}))},200),p&&setTimeout(function(){$("view-about").classList.add("animated")},400),hw.news.options.disclosure=!p,hw.init()}(window),WebFontConfig={google:{families:["Inconsolata"]}},function(){var e=document.createElement("script");e.src=("https:"==document.location.protocol?"https":"http")+"://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js",
e.type="text/javascript",e.async="true";var t=document.getElementsByTagName("script")[0];t.parentNode.insertBefore(e,t)}();
