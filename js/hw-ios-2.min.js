...
var o=0;o<a;o++)i[o]||(t=t.toLowerCase()),e.removeEventListener(i[o]+t,n,!1)}function u(e){var t=e.in,n=e.out,o=t.classList,i=n.classList,r=e.direction,a=f[r],s=function(){i.add("hidden"),i.remove(a[0]),o.remove(a[1]),c(t,"AnimationEnd",s)};l(t,"AnimationEnd",s),o.remove("hidden"),o.add(a[1]),i.add(a[0])}function d(e){var t,n=e.in,o=e.out,i=n.classList,r=o.classList;"up"==e.direction?(r.add("no-pointer"),i.remove("hidden"),i.add("slide-up")):(l(o,"AnimationEnd",t=function(){r.remove("slide-down"
),r.add("hidden"),i.remove("no-pointer"),c(o,"AnimationEnd",t)}),r.remove("slide-up"),r.add("slide-down"))}function t(){return 736<(e.offsetWidth||n.innerWidth)?"wide":"narrow"}var r=n.document,e=r.body,i=["webkit","moz","MS","o",""],a=i.length,f={rtl:["slide-out-to-left","slide-in-from-right"],ltr:["slide-out-to-right","slide-in-from-left"]},o=r.querySelector("meta[name=viewport]");o||((o=r.createElement("meta")).name="viewport",r.head.appendChild(o)),
