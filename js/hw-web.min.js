...
a.scrollTo(0,e[b]||0),e[b]=f()}});var h=c.head||c.getElementsByTagName("head")[0],i=function(){var b=a.innerHeight,d=$("view-height");d||(d=c.createElement("style"),d.id="view-height",h.appendChild(d)),a.innerWidth>=788&&(b*=.85),d.textContent=".view>.scroll{min-height: "+b+"px}"};if(a.addEventListener("resize",i,!1),a.addEventListener("orientationchange",i,!1),i(),ibento("#view-home-refresh","click",hw.news.reload),ibento("#view-home .more-link","click",function(a,b){hw.news.more(b)}),ibento("button.comments-toggle","click",function(a,b){hw.comments.toggle(b)
