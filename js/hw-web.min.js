...
c.b("<span>[deleted]</span>")}),a.pop()),c.s(c.f("deleted",a,b,1),a,b,1,0,0,"")||(c.b('<b class="user">'),c.b(c.v(c.f("user",a,b,0))),c.b("</b>")),c.b('<time><a href="#" data-id="'),c.b(c.v(c.f("id",a,b,0))),c.b('" class="comment-permalink">'),c.b(c.v(c.f("time_ago",a,b,0))),c.b("</a></time></p>"),c.s(c.f("deleted",a,b,1),a,b,1,0,0,"")||(c.b("<p>"),c.b(c.t(c.f("content",a,b,0))),c.b("<ul>"),c.b(c.rp("<comments_list0",a,b,"")),c.b("</ul>")),c.b("</li>")}),a.pop()),d.fl()},partials:{"<comments_list0":{
name:"comments_list",partials:{},subs:{}}},subs:{}}),"post-comments":new a({code:function(a,b,c){var d=this;return d.b(c=c||""),d.b('<div class="post-content">'),d.s(d.f("has_post",a,b,1),a,b,0,39,573,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<header><a href="'),c.b(c.v(c.f("url",a,b,0))),c.b('" target="_blank"><h1>'),c.b(c.v(c.f("title",a,b,0))),c.b("</h1>"),c.s(c.f("user",a,b,1),a,b,0,108,171,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.s(c.f("domain",a,b,1),a,b,0,119,160,"{{ }}")&&(c.rs(a,b,function(a,b,c){
c.b('<span class="link-text">'),c.b(c.v(c.f("domain",a,b,0))),c.b("</span>")}),a.pop())}),a.pop()),c.b('</a><p class="metadata">'),c.s(c.f("user",a,b,1),a,b,0,213,408,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b('<span class="inline-block">'),c.b(c.v(c.f("points",a,b,0))),c.b(" "),c.b(c.v(c.f("i_point",a,b,0))),c.b(" by "),c.b(c.v(c.f("user",a,b,0))),c.b('</span> <span class="inline-block">'),c.b(c.v(c.f("time_ago",a,b,0))),c.s(c.f("comments_count",a,b,1),a,b,0,340,382,"{{ }}")&&(c.rs(a,b,function(a,b,c){
...
d.b('<li id="story-'),d.b(d.v(d.f("id",a,b,0))),d.b('" data-index="'),d.b(d.v(d.f("i",a,b,0))),d.b('" class="post-'),d.b(d.v(d.f("type",a,b,0))),d.b('"><a href="'),d.b(d.v(d.f("url",a,b,0))),d.b('" class="'),d.s(d.f("detail_disclosure",a,b,1),a,b,0,110,127,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b("detail-disclosure")}),a.pop()),d.s(d.f("disclosure",a,b,1),a,b,0,164,174,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b("disclosure")}),a.pop()),d.b(" "),d.s(d.f("selected",a,b,1),a,b,0,203,211,"{{ }}")&&(d.rs(a,b,function(a,b,c){
c.b("selected")}),a.pop()),d.b('"><div class="number">'),d.b(d.v(d.f("i",a,b,0))),d.b('</div><div class="story"><b>'),d.b(d.v(d.f("title",a,b,0))),d.b("</b>"),d.s(d.f("user",a,b,1),a,b,0,301,593,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<span class="metadata">'),c.s(c.f("domain",a,b,1),a,b,0,335,380,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b('<span class="link-text">'),c.b(c.v(c.f("domain",a,b,0))),c.b("</span><br>")}),a.pop()),c.b('<span class="inline-block">'),c.b(c.v(c.f("points",a,b,0))),c.b(" "),
c.b(c.v(c.f("i_point",a,b,0))),c.b(" by "),c.b(c.v(c.f("user",a,b,0))),c.b('</span> <span class="inline-block">'),c.b(c.v(c.f("time_ago",a,b,0))),c.s(c.f("comments_count",a,b,1),a,b,0,518,560,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b(" &middot; "),c.b(c.v(c.f("comments_count",a,b,0))),c.b(" "),c.b(c.v(c.f("i_comment",a,b,0)))}),a.pop()),c.b("</span></span>")}),a.pop()),d.s(d.f("user",a,b,1),a,b,1,0,0,"")||(d.b('<span class="metadata">'),d.s(d.f("domain",a,b,1),a,b,0,645,690,"{{ }}")&&(d.rs(a,b,function(a,b,c){
c.b('<span class="link-text">'),c.b(c.v(c.f("domain",a,b,0))),c.b("</span><br>")}),a.pop()),d.b('<span class="inline-block">'),d.b(d.v(d.f("time_ago",a,b,0))),d.b("</span></span>")),d.b("</div></a>"),d.s(d.f("detail_disclosure",a,b,1),a,b,0,795,869,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<a href="#/item/'),c.b(c.v(c.f("id",a,b,0))),c.b('" class="detail-disclosure-button"><span></span></a>')}),a.pop()),d.b("</li>"),d.fl()},partials:{},subs:{}}),"stories-load":new a({code:function(a,b,c){var d=this;
return d.b(c=c||""),d.s(d.f("loading",a,b,1),a,b,0,12,82,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<div class="loader"><i class="icon-loading"></i> Loading&hellip;</div>')}),a.pop()),d.s(d.f("load_error",a,b,1),a,b,0,109,161,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<div class="load-error">Couldn\'t load stories.</div>')}),a.pop()),d.fl()},partials:{},subs:{}})}}(Hogan.Template),function(a){var b=a.document,c=a.$=function(a){return b.getElementById(a)},d={},e=function(a){var b={};for(var c in a)a.hasOwnProperty(c)&&(b[c]=a[c]);
return b},f={pub:function(a,b){var c=d[a];if(c)for(var e=0,f=c.length;f>e;e++)c[e].call(this,b)},sub:function(a,b){d[a]||(d[a]=[]),d[a].push(b)},currentView:null,hideAllViews:function(){for(var a=b.querySelectorAll(".view"),c=0,d=a.length;d>c;c++)a[c].classList.add("hidden")},tmpl:function(a,b){var c=TEMPLATES[a];if(c)return b?c.render(b):c},setTitle:function(a){var b="HackerWeb";a&&(a=a.replace(/^\s+|\s+$/g,""),a.toLowerCase()!=b.toLowerCase()&&(b=a+" – "+b)),document.title=b}};"undefined"!=typeof ga&&f.sub("logAPIError",function(a){
ga("send","event","Errors","API",a)});var g=f.tmpl;amplify.store.sessionStorage&&"function"==typeof amplify.store.sessionStorage||(amplify.store.sessionStorage=amplify.store.memory);var h=b.createElement("a"),i={},j=function(a){var b=i[a];if(b)return b;h.href=a;var c=h.hostname.replace(/^www\./,""),d=h.pathname.replace(/^\//,"").split("/")[0],e=d.length,f=c.length<=25&&e>3&&15>=e&&/^[^0-9][^.]+$/.test(d)?"/"+d:"";return b=c+f,i[a]=b,b},k=b.querySelector("#view-home .scroll"),l=k.querySelector("section"),m=!1;
f.news={options:{disclosure:!0},markupStory:function(a){return/^item/i.test(a.url)?a.url="#/item/"+a.id:(a.external=!0,a.domain=j(a.url)),f.news.options.disclosure?("link"==a.type&&(a.detail_disclosure=!0),/^#\//.test(a.url)&&(a.detail_disclosure=!1,a.disclosure=!0,a.domain=null)):a.id&&(a.url="#/item/"+a.id),a.i_point=1==a.points?"point":"points",a.i_comment=1==a.comments_count?"comment":"comments",g("post",a)},markupStories:function(a,b){var c="";b||(b=1);var d=f.news.markupStory;return a.forEach(function(a){
a.i=b++,c+=d(a)}),c},updateStory:function(a){if(a&&a.id){var b,d=a.id,e=a.data,g="hacker-news",h=amplify.store(g);if(h)for(var i=0,j=h.length;j>i;i++){var k=h[i];if(d==k.id){b=k;break}}if(!b&&(g="hacker-news2",h=amplify.store(g)))for(var i=0,j=h.length;j>i;i++){var k=h[i];if(d==k.id){b=k;break}}if(b){var l=!1;if(["title","url","time_ago","comments_count","points"].forEach(function(a){var c=e[a];b[a]!=c&&(b[a]=c,l=!0)}),l){amplify.store(g,h);var m=c("story-"+d);m&&(b.selected=!!m.querySelector("a[href].selected"),
b.i=m.dataset?m.dataset.index:m.getAttribute("data-index"),m.insertAdjacentHTML("afterend",f.news.markupStory(b)),m.parentNode.removeChild(m))}}}},render:function(a){if(!m){a||(a={});var b=amplify.store("hacker-news-cached"),d=g("stories-load"),e=function(a){var b=a.slice(),c='<ul class="tableview tableview-links" id="hwlist">'+f.news.markupStories(b)+(amplify.store("hacker-news2")?'<li><a class="more-link">More&hellip;<span class="loader"><i class="icon-loading"></i></span></a></li>':"")+"</ul>";
