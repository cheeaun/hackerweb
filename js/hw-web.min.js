...
)e[t].classList.add("hidden")},tmpl:function(e,t){var n=TEMPLATES[e];if(n)return t?n.render(t):n},setTitle:function(e){var t="HackerWeb";e&&(e=e.replace(/^\s+|\s+$/g,"")).toLowerCase()!=t.toLowerCase()&&(t=e+" – "+t),document.title=t}};"undefined"!=typeof ga&&_.sub("logAPIError",function(e){ga("send","event","Errors","API",e)});var k=_.tmpl;amplify.store.sessionStorage&&"function"==typeof amplify.store.sessionStorage||(amplify.store.sessionStorage=amplify.store.memory);function S(e){if(r=a[e]
)return r;s.href=e;var t=s.hostname.replace(/^www\./,""),n=s.pathname.replace(/^\//,"").split("/")[0],o=n.length,r=t+(t.length<=25&&3<o&&o<=15&&/^[^0-9][^.]+$/.test(n)?"/"+n:"");return a[e]=r}var s=w.createElement("a"),a={},l=w.querySelector("#view-home .scroll").querySelector("section"),c=!1;_.news={options:{disclosure:!0},markupStory:function(e){return/^item/i.test(e.url)?e.url="#/item/"+e.id:(e.external=!0,e.domain=S(e.url)),_.news.options.disclosure?("link"==e.type&&(e.detail_disclosure=!0),
/^#\//.test(e.url)&&(e.detail_disclosure=!1,e.disclosure=!0,e.domain=null)):e.id&&(e.url="#/item/"+e.id),e.i_point=1==e.points?"point":"points",e.i_comment=1==e.comments_count?"comment":"comments",k("post",e)},markupStories:function(e,t){var n="";t=t||1;var o=_.news.markupStory;return e.forEach(function(e){e.i=t++,n+=o(e)}),n},updateStory:function(e){if(e&&e.id){var n,o,t,r=e.id,i=e.data,s="hacker-news",a=amplify.store(s);if(a)for(var l=0,c=a.length;l<c;l++){if(r==(u=a[l]).id){n=u;break}}if(
!n&&(s="hacker-news2",a=amplify.store(s)))for(var u,l=0,c=a.length;l<c;l++){if(r==(u=a[l]).id){n=u;break}}n&&(o=!1,["title","url","time_ago","comments_count","points"].forEach(function(e){var t=i[e];n[e]!=t&&(n[e]=t,o=!0)}),o&&(amplify.store(s,a),(t=f("story-"+r))&&(n.selected=!!t.querySelector("a[href].selected"),n.i=t.dataset?t.dataset.index:t.getAttribute("data-index"),t.insertAdjacentHTML("afterend",_.news.markupStory(n)),t.parentNode.removeChild(t))))}},render:function(e){var t,n,o,r,i,s
;c||(e=e||{},t=amplify.store("hacker-news-cached"),n=k("stories-load"),o=function(e){var t=e.slice(),n='<ul class="tableview tableview-links" id="hwlist">'+_.news.markupStories(t)+(amplify.store("hacker-news2")?'<li><a class="more-link">More&hellip;<span class="loader"><i class="icon-loading"></i></span></a></li>':"")+"</ul>";l.innerHTML=n,_.pub("onRenderNews")},t?(r=amplify.store("hacker-news"),(i=e.delay)?(c=!0,l.innerHTML=n.render({loading:!0}),setTimeout(function(){c=!1,o(r)},i)):o(r)):(c=!0
,l.innerHTML=n.render({loading:!0}),s=function(){l.innerHTML=n.render({load_error:!0}),_.pub("logAPIError","news")},hnapi.news(function(e){c=!1,e&&!e.error?(amplify.store("hacker-news",e),amplify.store("hacker-news-cached",!0,{expires:6e5}),amplify.store("hacker-news2",null),o(e),hnapi.news2(function(e){e&&!e.error&&(amplify.store("hacker-news2",e),f("hwlist").insertAdjacentHTML("beforeend",'<li><a class="more-link">More&hellip;<span class="loader"></span></a></li>'))})):s()},function(e){c=!1,s(
)})))},reload:function(){_.news.render({delay:300})},more:function(o){var r;o.classList.contains("loading")||(o.classList.add("loading"),r=amplify.store("hacker-news2"),setTimeout(function(){o.classList.remove("loading");var e,t,n=o.parentNode;n&&(n.parentNode&&n.parentNode.removeChild(n),r&&(e=r.slice(),t=_.news.markupStories(e,31),f("hwlist").insertAdjacentHTML("beforeend",t)))},400))}};var t=f("view-comments"),x=t.querySelector("header h1"),T=t.querySelector("section");_.comments={
currentID:null,render:function(t){if(t){var e=amplify.store.sessionStorage("hacker-item-"+t);if(_.comments.currentID!=t||!e){_.comments.currentID=t;function n(e,t){var n=function(e){var t={};for(var n in e)e.hasOwnProperty(n)&&(t[n]=e[n]);return t}(e),o=k("post-comments");if(n.has_post=!!n.title,!n.has_post)return _.setTitle(),x.innerHTML="",T.innerHTML=o.render(n),_.pub("adjustCommentsSection"),void _.pub("onRenderComments");var r,i,s=k("comments");/^item/i.test(n.url
...
n.short_hn_url="news.ycombinator.com/item?id="+t,n.hn_url="//"+n.short_hn_url,_.setTitle(n.title),x.innerHTML=n.title;var a=o.render(n,{comments_list:s}),l=w.createElement("div");l.innerHTML=a;for(var c=l.querySelectorAll("a"),u=0,f=c.length;u<f;u++){c[u].target="_blank"}var p=n.user;if(p)for(var d=l.querySelectorAll(".user"),u=0,f=d.length;u<f;u++){var m=d[u];m.textContent.trim()==p&&(m.classList.add("op"),m.title="Original Poster")}if(2e4<a.length)for(var h=l.querySelectorAll(
".comments>ul>li>ul"),b=k("comments-toggle"),v=0,f=h.length;v<f;v++){var g=h[v],y=g.querySelectorAll(".metadata").length;g.style.display="none",y&&g.insertAdjacentHTML("beforebegin",b.render({comments_count:y,i_reply:1==y?"reply":"replies"}))}for(;T.hasChildNodes();)T.removeChild(T.childNodes[0]);for(;l.hasChildNodes();)T.appendChild(l.childNodes[0]);delete l,_.pub("onRenderComments")}if(e)T.scrollTop=0,n(e,t);else{var o=amplify.store("hacker-news");if(o)for(var r=0,i=o.length;r<i;r++){
var s=o[r];if(t==s.id){e=s;break}}if(!e)if(o=amplify.store("hacker-news2"))for(r=0,i=o.length;r<i;r++){s=o[r];if(t==s.id){e=s;break}}e?(e.loading=!0,n(e,t)):n({loading:!0},t);function a(){e?(delete e.loading,e.load_error=!0,n(e,t)):n({load_error:!0},t),_.pub("logAPIError","comments")}hnapi.item(t,function(e){_.comments.currentID==t&&(!e||e.error&&"comments"==_.currentView?a():(amplify.store.sessionStorage("hacker-item-"+t,e,{expires:3e5}),_.news.updateStory({id:t,data:e}),n(e,t)))},function(e){
_.comments.currentID==t&&a()})}}}},toggle:function(e){var t,n,o=e.nextElementSibling;o&&(t=o.style,n=T.scrollTop,t.display="none"==t.display?"":"none",T.scrollTop=n)},reload:function(){_.comments.currentID=null,ruto.reload()}},_.init=function(){_.news.render(),ruto.init();var a=Array.from(document.styleSheets).find(function(e){return/hw.*\.css/i.test(e.href)});function e(){var t,n,e,o,r,i=Array.from(a.cssRules).find(function(e){return e.media&&/color-scheme:\s*dark/i.test(e.media.mediaText)})
;function s(e){"dark"===e?(i.media.mediaText="screen",n.content="dark"):"light"===e?(i.media.mediaText="not all",n.content="light"):(i.media.mediaText="(prefers-color-scheme: dark)",n.content="dark light")}i&&(f("hw-appearance-container").hidden=!1,t=f("hw-appearance"),n=f("meta-color-scheme"),e=window.matchMedia&&"not all"!==window.matchMedia("(prefers-color-scheme)").media,o="hw-appearance",s(r=localStorage.getItem(o)||"auto"),e?(t.querySelector("[name=hw-appearance][value=auto]"
).parentNode.hidden=!1,t.querySelector("[name=hw-appearance][value="+r+"]").checked=!0):(/(light|dark)/i.test(r)||(r="light"),t.querySelector('[name=hw-appearance][value="'+r+'"]').checked=!0),t.onclick=function(){var e=t.querySelector("[name=hw-appearance]:checked").value;localStorage.setItem(o,e),s(e)})}a?e():setTimeout(e,1e3)},e.hw=_,ruto.config({before:function(e,t){_.hideAllViews();var n=f("view-"+t);n.classList.remove("hidden"),_.currentView=t,_.setTitle(n.querySelector("header h1"
).textContent)},notfound:function(){ruto.go("/")}}).add("/","home").add("/about","about").add(/^\/item\/(\d+)$/i,"comments",function(e,t){_.comments.render(t)})}(window),function(o){var n,r,e,i,t,s,a,l;o.addEventListener&&((n=o.document).body,r={},i=function(){return o.pageYOffset||"CSS1Compat"===n.compatMode&&n.documentElement.scrollTop||0},t=function(){var e=location.hash.slice(1),t=r[e]=i(),n="hacker-scrolltop-"+e;amplify.store.sessionStorage(n,t)},o.addEventListener("scroll",function(){
clearTimeout(e),e=setTimeout(t,500)},!1),ruto.config({on:function(){var e=location.hash.slice(1),t="hacker-scrolltop-"+e,n=amplify.store.sessionStorage(t);o.scrollTo(0,r[e]||n||0),n=r[e]=i(),amplify.store.sessionStorage(t,n)}}),s=n.head||n.getElementsByTagName("head")[0],a=function(){var e=o.innerHeight,t=$("view-height");t||((t=n.createElement("style")).id="view-height",s.appendChild(t)),788<=o.innerWidth&&(e*=.9),t.textContent=".view>.scroll{min-height: "+e+"px}"},o.addEventListener("resize",a
,!1),o.addEventListener("orientationchange",a,!1),a(),ibento("#view-home-refresh","click",hw.news.reload),ibento("#view-home .more-link","click",function(e,t){hw.news.more(t)}),ibento("button.comments-toggle","click",function(e,t){hw.comments.toggle(t)}),ibento("#view-comments .load-error button","click",hw.comments.reload),/Mobile;.*Firefox/.test(navigator.userAgent)&&navigator.mozApps&&((l=navigator.mozApps.getSelf()).onsuccess=function(){l.result&&ibento('a[href]:not([href^="#"])',"click",
function(e,t){e.preventDefault(),window.open(t.href,"browser")})}),window.onload=hw.init)}(window);
