...
for(var b=a.length-1;b>0;b--){var c=Math.floor(Math.random()*(b+1)),d=a[b];a[b]=a[c],a[c]=d}};j(i);var k=i.length,l=function(a,b,c,d){var e=k-1>a?function(){l(a+1,b,c,d)}:d;h(i[a]+b,c,e)},m=function(a,b,c){h(i[0]+a,b,function(){l(0,a,b,c)})},n={urls:i,news:function(a,b){m("news",a,b)},news2:function(a,b){m("news2",a,b)},item:function(a,b,c){m("item/"+a,b,c)},comments:function(a,b,c){m("comments/"+a,b,c)}};a.hnapi=n}(window),function(a){var b=a.document,c=function(a,c){var d=b.documentElement,e=d.matchesSelector||d.mozMatchesSelector||d.webkitMatchesSelector||d.oMatchesSelector||d.msMatchesSelector;
return e.call(a,c)},d=function(a,b){var d=!1;do d=c(a,b);while(!d&&(a=a.parentNode)&&a.ownerDocument);return d?a:!1};a.ibento=function(a,c,e){var f=b.body;f.addEventListener(c,function(b){var c=d(b.target,a);c&&e.call(f,b,c)})}}(window),"document"in self&&("classList"in document.createElement("_")?!function(){"use strict";var a=document.createElement("_");if(a.classList.add("c1","c2"),!a.classList.contains("c2")){var b=function(a){var b=DOMTokenList.prototype[a];DOMTokenList.prototype[a]=function(a){
var c,d=arguments.length;for(c=0;d>c;c++)a=arguments[c],b.call(this,a)}};b("add"),b("remove")}if(a.classList.toggle("c3",!1),a.classList.contains("c3")){var c=DOMTokenList.prototype.toggle;DOMTokenList.prototype.toggle=function(a,b){return 1 in arguments&&!this.contains(a)==!b?b:c.call(this,a)}}a=null}():!function(a){"use strict";if("Element"in a){var b="classList",c="prototype",d=a.Element[c],e=Object,f=String[c].trim||function(){return this.replace(/^\s+|\s+$/g,"")},g=Array[c].indexOf||function(a){
for(var b=0,c=this.length;c>b;b++)if(b in this&&this[b]===a)return b;return-1},h=function(a,b){this.name=a,this.code=DOMException[a],this.message=b},i=function(a,b){if(""===b)throw new h("SYNTAX_ERR","An invalid or illegal string was specified");if(/\s/.test(b))throw new h("INVALID_CHARACTER_ERR","String contains an invalid character");return g.call(a,b)},j=function(a){for(var b=f.call(a.getAttribute("class")||""),c=b?b.split(/\s+/):[],d=0,e=c.length;e>d;d++)this.push(c[d]);this._updateClassName=function(){
a.setAttribute("class",this.toString())}},k=j[c]=[],l=function(){return new j(this)};if(h[c]=Error[c],k.item=function(a){return this[a]||null},k.contains=function(a){return a+="",-1!==i(this,a)},k.add=function(){var a,b=arguments,c=0,d=b.length,e=!1;do a=b[c]+"",-1===i(this,a)&&(this.push(a),e=!0);while(++c<d);e&&this._updateClassName()},k.remove=function(){var a,b,c=arguments,d=0,e=c.length,f=!1;do for(a=c[d]+"",b=i(this,a);-1!==b;)this.splice(b,1),f=!0,b=i(this,a);while(++d<e);f&&this._updateClassName();
},k.toggle=function(a,b){a+="";var c=this.contains(a),d=c?b!==!0&&"remove":b!==!1&&"add";return d&&this[d](a),b===!0||b===!1?b:!c},k.toString=function(){return this.join(" ")},e.defineProperty){var m={get:l,enumerable:!0,configurable:!0};try{e.defineProperty(d,b,m)}catch(a){-2146823252===a.number&&(m.enumerable=!1,e.defineProperty(d,b,m))}}else e[c].__defineGetter__&&d.__defineGetter__(b,l)}}(self)),function(a){TEMPLATES={"comments-toggle":new a({code:function(a,b,c){var d=this;return d.b(c=c||""),
d.b('<button class="comments-toggle">'),d.b(d.v(d.f("comments_count",a,b,0))),d.b(" "),d.b(d.v(d.f("i_reply",a,b,0))),d.b("</button>"),d.fl()},partials:{},subs:{}}),comments:new a({code:function(a,b,c){var d=this;return d.b(c=c||""),d.s(d.f("comments",a,b,1),a,b,0,13,327,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<li><p class="metadata '),c.s(c.f("deleted",a,b,1),a,b,0,48,55,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b("deleted")}),a.pop()),c.b('">'),c.s(c.f("deleted",a,b,1),a,b,0,81,103,"{{ }}")&&(c.rs(a,b,function(a,b,c){
c.b("<span>[deleted]</span>")}),a.pop()),c.s(c.f("deleted",a,b,1),a,b,1,0,0,"")||(c.b('<b class="user">'),c.b(c.v(c.f("user",a,b,0))),c.b("</b>")),c.b('<time><a href="#" data-id="'),c.b(c.v(c.f("id",a,b,0))),c.b('" class="comment-permalink">'),c.b(c.v(c.f("time_ago",a,b,0))),c.b("</a></time></p>"),c.s(c.f("deleted",a,b,1),a,b,1,0,0,"")||(c.b("<p>"),c.b(c.t(c.f("content",a,b,0)))),c.b("<ul>"),c.b(c.rp("<comments_list0",a,b,"")),c.b("</ul></li>")}),a.pop()),d.fl()},partials:{"<comments_list0":{name:"comments_list",
partials:{},subs:{}}},subs:{}}),"post-comments":new a({code:function(a,b,c){var d=this;return d.b(c=c||""),d.b('<div class="post-content">'),d.s(d.f("has_post",a,b,1),a,b,0,39,577,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<header><h1><a href="'),c.b(c.v(c.f("url",a,b,0))),c.b('" target="_blank">'),c.b(c.v(c.f("title",a,b,0))),c.b("<br>"),c.s(c.f("user",a,b,1),a,b,0,107,170,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.s(c.f("domain",a,b,1),a,b,0,118,159,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b('<span class="link-text">'),
c.b(c.v(c.f("domain",a,b,0))),c.b("</span>")}),a.pop())}),a.pop()),c.b('</a></h1><p class="metadata">'),c.s(c.f("user",a,b,1),a,b,0,217,412,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b('<span class="inline-block">'),c.b(c.v(c.f("points",a,b,0))),c.b(" "),c.b(c.v(c.f("i_point",a,b,0))),c.b(" by "),c.b(c.v(c.f("user",a,b,0))),c.b('</span> <span class="inline-block">'),c.b(c.v(c.f("time_ago",a,b,0))),c.s(c.f("comments_count",a,b,1),a,b,0,344,386,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b(" &middot; "),c.b(c.v(c.f("comments_count",a,b,0))),
...
c.s(c.f("has_poll",a,b,1),a,b,0,667,906,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b('<ul class="poll">'),c.s(c.f("poll",a,b,1),a,b,0,693,892,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b('<li title="'),c.b(c.v(c.f("percentage",a,b,0))),c.b('%"><span class="poll-details"><b>'),c.b(c.v(c.f("item",a,b,0))),c.b('</b> <span class="points">'),c.b(c.v(c.f("points",a,b,0))),c.b(" "),c.b(c.v(c.f("i_point",a,b,0))),c.b('</span></span><div class="poll-bar"><span style="width: '),c.b(c.v(c.f("width",a,b,0))),c.b('"></span></div></li>');
}),a.pop()),c.b("</ul>")}),a.pop()),c.b("</section>")}),a.pop()),d.b('</div><section class="comments">'),d.s(d.f("loading",a,b,1),a,b,0,989,1059,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<div class="loader"><i class="icon-loading"></i> Loading&hellip;</div>')}),a.pop()),d.s(d.f("load_error",a,b,1),a,b,0,1086,1169,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<div class="load-error">Couldn\'t load comments.<br><button>Try again</button></div>')}),a.pop()),d.s(d.f("loading",a,b,1),a,b,1,0,0,"")||d.s(d.f("load_error",a,b,1),a,b,1,0,0,"")||(d.s(d.f("has_comments",a,b,1),a,b,0,1228,1255,"{{ }}")&&(d.rs(a,b,function(a,b,c){
c.b("<ul>"),c.b(c.rp("<comments_list0",a,b,"")),c.b("</ul>")}),a.pop()),d.s(d.f("has_comments",a,b,1),a,b,1,0,0,"")||d.b('<p class="no-comments">No comments.</p>')),d.b("</section>"),d.fl()},partials:{"<comments_list0":{name:"comments_list",partials:{},subs:{}}},subs:{}}),post:new a({code:function(a,b,c){var d=this;return d.b(c=c||""),d.b('<li id="story-'),d.b(d.v(d.f("id",a,b,0))),d.b('" data-index="'),d.b(d.v(d.f("i",a,b,0))),d.b('" class="post-'),d.b(d.v(d.f("type",a,b,0))),d.b('"><a href="'),
d.b(d.v(d.f("url",a,b,0))),d.b('" class="'),d.s(d.f("detail_disclosure",a,b,1),a,b,0,110,127,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b("detail-disclosure")}),a.pop()),d.s(d.f("disclosure",a,b,1),a,b,0,164,174,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b("disclosure")}),a.pop()),d.b(" "),d.s(d.f("selected",a,b,1),a,b,0,203,211,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b("selected")}),a.pop()),d.b('"><div class="number">'),d.b(d.v(d.f("i",a,b,0))),d.b('</div><div class="story"><b>'),d.b(d.v(d.f("title",a,b,0))),
d.b("</b>"),d.s(d.f("user",a,b,1),a,b,0,301,589,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<span class="metadata">'),c.s(c.f("domain",a,b,1),a,b,0,335,376,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b('<span class="link-text">'),c.b(c.v(c.f("domain",a,b,0))),c.b("</span>")}),a.pop()),c.b('<span class="inline-block">'),c.b(c.v(c.f("points",a,b,0))),c.b(" "),c.b(c.v(c.f("i_point",a,b,0))),c.b(" by "),c.b(c.v(c.f("user",a,b,0))),c.b('</span> <span class="inline-block">'),c.b(c.v(c.f("time_ago",a,b,0))),c.s(c.f("comments_count",a,b,1),a,b,0,514,556,"{{ }}")&&(c.rs(a,b,function(a,b,c){
c.b(" &middot; "),c.b(c.v(c.f("comments_count",a,b,0))),c.b(" "),c.b(c.v(c.f("i_comment",a,b,0)))}),a.pop()),c.b("</span></span>")}),a.pop()),d.s(d.f("user",a,b,1),a,b,1,0,0,"")||(d.b('<span class="metadata">'),d.s(d.f("domain",a,b,1),a,b,0,641,686,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<span class="link-text">'),c.b(c.v(c.f("domain",a,b,0))),c.b("</span><br>")}),a.pop()),d.b('<span class="inline-block">'),d.b(d.v(d.f("time_ago",a,b,0))),d.b("</span></span>")),d.b("</div></a>"),d.s(d.f("detail_disclosure",a,b,1),a,b,0,791,865,"{{ }}")&&(d.rs(a,b,function(a,b,c){
...
var c=h.hostname.replace(/^www\./,""),d=h.pathname.replace(/^\//,"").split("/")[0],e=d.length,f=c.length<=25&&e>3&&15>=e&&/^[^0-9][^.]+$/.test(d)?"/"+d:"";return b=c+f},k=b.querySelector("#view-home .scroll"),l=k.querySelector("section"),m=!1;f.news={options:{disclosure:!0},markupStory:function(a){return/^item/i.test(a.url)?a.url="#/item/"+a.id:(a.external=!0,a.domain=j(a.url)),f.news.options.disclosure?("link"==a.type&&(a.detail_disclosure=!0),/^#\//.test(a.url)&&(a.detail_disclosure=!1,a.disclosure=!0,
a.domain=null)):a.id&&(a.url="#/item/"+a.id),a.i_point=1==a.points?"point":"points",a.i_comment=1==a.comments_count?"comment":"comments",g("post",a)},markupStories:function(a,b){var c="";b||(b=1);var d=f.news.markupStory;return a.forEach(function(a){a.i=b++,c+=d(a)}),c},updateStory:function(a){if(a&&a.id){var b,d=a.id,e=a.data,g="hacker-news",h=amplify.store(g);if(h)for(var i=0,j=h.length;j>i;i++){var k=h[i];if(d==k.id){b=k;break}}if(!b&&(g="hacker-news2",h=amplify.store(g)))for(var i=0,j=h.length;j>i;i++){
...
a.classList.add("loading");var b=amplify.store("hacker-news2");setTimeout(function(){a.classList.remove("loading");var d=a.parentNode;if(d&&(d.parentNode&&d.parentNode.removeChild(d),b)){var e=b.slice(),g=f.news.markupStories(e,31);c("hwlist").insertAdjacentHTML("beforeend",g)}},400)}};var n=c("view-comments"),o=n.querySelector("header h1"),p=n.querySelector("section");f.comments={currentID:null,render:function(a){if(a){var c=amplify.store.sessionStorage("hacker-item-"+a);if(f.comments.currentID!=a||!c){
f.comments.currentID=a;var d=function(a,c){var d=e(a),h=g("post-comments");if(d.has_post=!!d.title,!d.has_post)return f.setTitle(),o.innerHTML="",p.innerHTML=h.render(d),f.pub("adjustCommentsSection"),void f.pub("onRenderComments");var i=g("comments");if(/^item/i.test(d.url)?d.url="//news.ycombinator.com/"+d.url:d.domain=j(d.url),d.has_comments=d.comments&&!!d.comments.length,d.i_point=1==d.points?"point":"points",d.i_comment=1==d.comments_count?"comment":"comments",d.has_content=!!d.content,d.poll){
var k=0,l=0;d.poll.forEach(function(a){var b=a.points;b>l&&(l=b),k+=b,a.i_point=1==b?"point":"points"}),d.poll.forEach(function(a){var b=a.points;a.percentage=(b/k*100).toFixed(1),a.width=(b/l*100).toFixed(1)+"%"}),d.has_poll=d.has_content=!0}d.short_hn_url="news.ycombinator.com/item?id="+c,d.hn_url="//"+d.short_hn_url,f.setTitle(d.title),o.innerHTML=d.title;var m=h.render(d,{comments_list:i}),n=b.createElement("div");n.innerHTML=m;for(var q=n.querySelectorAll("a"),r=0,s=q.length;s>r;r++){var t=q[r];
if(t.classList.contains("comment-permalink")){var c=t.dataset?t.dataset.id:t.getAttribute("data-id");t.href="//news.ycombinator.com/item?id="+c}t.target="_blank"}var u=d.user;if(u)for(var v=n.querySelectorAll(".user"),r=0,s=v.length;s>r;r++){var w=v[r];w.textContent.trim()==u&&(w.classList.add("op"),w.title="Original Poster")}if(m.length>2e4)for(var x=n.querySelectorAll(".comments>ul>li>ul"),y=g("comments-toggle"),z=0,s=x.length;s>z;z++){var A=x[z],B=A.querySelectorAll(".metadata").length;A.style.display="none",
B&&A.insertAdjacentHTML("beforebegin",y.render({comments_count:B,i_reply:1==B?"reply":"replies"}))}for(;p.hasChildNodes();)p.removeChild(p.childNodes[0]);for(;n.hasChildNodes();)p.appendChild(n.childNodes[0]);delete n,f.pub("onRenderComments")};if(c)p.scrollTop=0,d(c,a);else{var h=amplify.store("hacker-news");if(h)for(var i=0,k=h.length;k>i;i++){var l=h[i];if(a==l.id){c=l;break}}if(!c){var h=amplify.store("hacker-news2");if(h)for(var i=0,k=h.length;k>i;i++){var l=h[i];if(a==l.id){c=l;break}}}c?(c.loading=!0,
d(c,a)):d({loading:!0},a);var m=function(){c?(delete c.loading,c.load_error=!0,d(c,a)):d({load_error:!0},a),f.pub("logAPIError","comments")};hnapi.item(a,function(b){if(f.comments.currentID==a){if(!b||b.error&&"comments"==f.currentView)return void m();amplify.store.sessionStorage("hacker-item-"+a,b,{expires:3e5}),f.news.updateStory({id:a,data:b}),d(b,a)}},function(b){f.comments.currentID==a&&m()})}}}},toggle:function(a){var b=a.nextElementSibling;if(b){var c=b.style,d=p.scrollTop;c.display="none"==c.display?"":"none",
p.scrollTop=d}},reload:function(){f.comments.currentID=null,ruto.reload()}},f.init=function(){f.news.render(),ruto.init()},a.hw=f,ruto.config({before:function(a,b){f.hideAllViews();var d=c("view-"+b);d.classList.remove("hidden"),f.currentView=b,f.setTitle(d.querySelector("header h1").textContent)},notfound:function(){ruto.go("/")}}).add("/","home").add("/about","about").add(/^\/item\/(\d+)$/i,"comments",function(a,b){f.comments.render(b)})}(window),function(a){if(a.addEventListener){var b,c=a.document,d=(c.body,
{}),e=function(){return a.pageYOffset||"CSS1Compat"===c.compatMode&&c.documentElement.scrollTop||0},f=function(){var a=location.hash.slice(1),b=d[a]=e(),c="hacker-scrolltop-"+a;amplify.store.sessionStorage(c,b)};a.addEventListener("scroll",function(){clearTimeout(b),b=setTimeout(f,500)},!1),ruto.config({on:function(){var b=location.hash.slice(1),c="hacker-scrolltop-"+b,f=amplify.store.sessionStorage(c);a.scrollTo(0,d[b]||f||0),f=d[b]=e(),amplify.store.sessionStorage(c,f)}});var g=c.head||c.getElementsByTagName("head")[0],h=function(){
var b=a.innerHeight,d=$("view-height");d||(d=c.createElement("style"),d.id="view-height",g.appendChild(d)),a.innerWidth>=788&&(b*=.9),d.textContent=".view>.scroll{min-height: "+b+"px}"};if(a.addEventListener("resize",h,!1),a.addEventListener("orientationchange",h,!1),h(),ibento("#view-home-refresh","click",hw.news.reload),ibento("#view-home .more-link","click",function(a,b){hw.news.more(b)}),ibento("button.comments-toggle","click",function(a,b){hw.comments.toggle(b)}),ibento("#view-comments .load-error button","click",hw.comments.reload),
/Mobile;.*Firefox/.test(navigator.userAgent)&&navigator.mozApps){var i=navigator.mozApps.getSelf();i.onsuccess=function(){i.result&&ibento('a[href]:not([href^="#"])',"click",function(a,b){a.preventDefault(),window.open(b.href,"browser")})}}window.onload=hw.init}}(window),WebFontConfig={google:{families:["Open+Sans:400,400italic,600,600italic"]}},function(){var a=document.createElement("script");a.src=("https:"==document.location.protocol?"https":"http")+"://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js",
