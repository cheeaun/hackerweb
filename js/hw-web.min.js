...
}),ibento("section.comments li>a.more-link","click",function(a,b){hw.comments.more(b)}),ibento("#view-comments .load-error button","click",hw.comments.reload),/Mobile;.*Firefox/.test(navigator.userAgent)&&navigator.mozApps){var j=navigator.mozApps.getSelf();j.onsuccess=function(){j.result&&ibento('a:not([href^="#"])',"click",function(a,b){a.preventDefault(),window.open(b.href,"browser")})}}hw.init()}}(window);
/*
