...
o.content="light"):(t.media.mediaText="(prefers-color-scheme: dark)",o.content="dark light")}!s||(t=Array.from(s.cssRules).find(function(e){return e.media&&/color-scheme:\s*dark/i.test(e.media.mediaText)}))&&(f("hw-appearance-container").hidden=!1,n=f("hw-appearance"),o=f("meta-color-scheme"),e=window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches,r="hw-appearance",a(i=localStorage.getItem(r)||"auto"),e?(n.querySelector("[name=hw-appearance][value=auto]"
