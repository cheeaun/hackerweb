...
d.b("</b>"),d.s(d.f("user",a,b,1),a,b,0,301,584,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<div class="metadata">'),c.s(c.f("domain",a,b,1),a,b,0,334,373,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b('<div class="link-text">'),c.b(c.v(c.f("domain",a,b,0))),c.b("</div>")}),a.pop()),c.b('<span class="inline-block">'),c.b(c.v(c.f("points",a,b,0))),c.b(" "),c.b(c.v(c.f("i_point",a,b,0))),c.b(" by "),c.b(c.v(c.f("user",a,b,0))),c.b('</span><span class="inline-block">'),c.b(c.v(c.f("time_ago",a,b,0))),c.s(c.f("comments_count",a,b,1),a,b,0,510,552,"{{ }}")&&(c.rs(a,b,function(a,b,c){
c.b(" &middot; "),c.b(c.v(c.f("comments_count",a,b,0))),c.b(" "),c.b(c.v(c.f("i_comment",a,b,0)))}),a.pop()),c.b("</span></div>")}),a.pop()),d.s(d.f("user",a,b,1),a,b,1,0,0,"")||(d.b('<div class="metadata">'),d.s(d.f("domain",a,b,1),a,b,0,635,680,"{{ }}")&&(d.rs(a,b,function(a,b,c){c.b('<span class="link-text">'),c.b(c.v(c.f("domain",a,b,0))),c.b("</span><br>")}),a.pop()),d.b('<span class="inline-block">'),d.b(d.v(d.f("time_ago",a,b,0))),d.b("</span></div>")),d.b("</div></a>"),d.s(d.f("detail_disclosure",a,b,1),a,b,0,784,858,"{{ }}")&&(d.rs(a,b,function(a,b,c){
