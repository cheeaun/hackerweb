...
).style.display=""):r?"comments"!=r&&((i=n[1])&&hw.comments.currentID!=i&&(s.querySelector("section").scrollTop=0),c({in:s,out:$("view-"+r),direction:"rtl"})):(a(),s.classList.remove("hidden")),hw.currentView="comments"}}}),n.addEventListener("pagehide",function(){for(var e=r.querySelectorAll(".view"),t={},n=0,o=e.length;n<o;n++){var i=e[n];t[i.id]=i.querySelector(".scroll section").scrollTop||0}amplify.store("hacker-scrolltops",t)},!1);function s(){var t=amplify.store("hacker-scrolltops")
;setTimeout(function(){for(var e in t)$(e).querySelector(".scroll section").scrollTop=t[e]},1)}var m,h;n.addEventListener("pageshow",s,!1),s(),a&&(m=r.querySelectorAll(".view>.scroll"),h=null,Array.prototype.forEach.call(m,function(e){e.addEventListener("touchstart",function(){var e;n.innerHeight!=h&&(n.scrollTo(0,0),i&&((e=r.createElement("div")).style.height="600px",u.appendChild(e),setTimeout(function(){u.removeChild(e)},100)),h=n.innerHeight)},!1)})),tappable(
".view>header a.header-button[href]",{noScroll:!0,onTap:function(e,t){var n=t.hash;f&&/about/i.test(ruto.current)&&"#/"==n?ruto.back("/"):location.hash=n}}),tappable("#view-home-refresh",{noScroll:!0,onTap:hw.news.reload});var v,b=!1;tappable(".view>header h1",{onTap:function(e,t){var n,o=t.parentNode.nextElementSibling.firstElementChild;if(0==o.scrollTop||b){a&&(n=u.style.height,u.style.height="100%",setTimeout(function(){u.style.height=n},100))}else{if(b)return;b=!0;var i=o.style.overflow
;o.style.overflow="hidden",setTimeout(function(){o.style.overflow=i;var e=new TWEEN.Tween({scrollTop:o.scrollTop}).to({scrollTop:0},300).easing(TWEEN.Easing.Cubic.InOut).onUpdate(function(){o.scrollTop=this.scrollTop}).onComplete(function(){cancelAnimationFrame(n),e.stop(),b=!1,delete e}).start(),t=function(){TWEEN.update(),requestAnimationFrame(t)},n=requestAnimationFrame(t)},200)}}}),tappable("#view-home .tableview-links li>a:first-child",{allowClick:!f,activeClassDelay:100,
inactiveClassDelay:f?100:1e3,onStart:function(e,t){var n;!f||(n=t.parentNode)&&(n=n.parentNode,v=setTimeout(function(){n&&n.classList.add("list-tapped")},100))},onMove:function(){f&&clearTimeout(v)},onEnd:function(e,t){var n;f&&(clearTimeout(v),n=t.parentNode.parentNode,setTimeout(function(){n&&n.classList.remove("list-tapped")},100))},onTap:function(e,t){t.classList.contains("more-link")?hw.news.more(t):/^#\//.test(t.getAttribute("href"))?location.hash=t.hash:t.href&&f&&n.open(t.href)}}),
...
)[1];for(var t,n=$("view-home"),o=n.querySelectorAll("a[href].selected"),i=0,r=o.length;i<r;i++)o[i].classList.remove("selected");!e||(t=n.querySelector('a[href*="item/'+e+'"]'))&&(t.classList.add("selected"),setTimeout(function(){t.scrollIntoViewIfNeeded?t.scrollIntoViewIfNeeded():t.scrollIntoView()},1))}}),hw.sub("onRenderNews",function(){hw.pub("selectCurrentStory")}),n.addEventListener("pageshow",function(){setTimeout(function(){"home"==hw.currentView&&$("hwlist")&&!amplify.store(
"hacker-news-cached")&&hw.news.reload()},1)},!1);function w(){var e,t,n,o=r.querySelector("#view-comments section");o&&(e=o.querySelector(".post-content"),o.querySelector(".comments")&&(t=o.offsetHeight-e.offsetHeight+1,(n=$("comment-section-style"))||((n=r.createElement("style")).id="comment-section-style",r.head.appendChild(n)),n.textContent=".view section.comments{min-height: "+t+"px;}"))}hw.sub("onRenderComments",function(){setTimeout(w,f?1:360)}),n.addEventListener("resize",w,!1),
n.addEventListener("orientationchange",w,!1);function y(){g&&(u.style.height=screen.height+"px",setTimeout(function(){n.scrollTo(0,0),u.style.height=n.innerHeight+"px"},1))}var g=void 0!==n.orientation;f||("complete"==r.readyState?y():n.addEventListener("load",y,!1),g&&(n.onorientationchange=y)),hw.news.options.disclosure=!f,hw.init()}(window);
