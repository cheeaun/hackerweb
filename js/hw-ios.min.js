...
;var s=Array.from(document.styleSheets).find(function(e){return/hw.*\.css/i.test(e.href)});function e(){var t,n,e,o,i,r=Array.from(s.cssRules).find(function(e){return e.media&&/color-scheme:\s*dark/i.test(e.media.mediaText)});function a(e){"dark"===e?(r.media.mediaText="screen",n.content="dark"):"light"===e?(r.media.mediaText="not all",n.content="light"):(r.media.mediaText="(prefers-color-scheme: dark)",n.content="dark light")}r&&(d("hw-appearance-container").hidden=!1,t=d("hw-appearance"),n=d(
"meta-color-scheme"),e=window.matchMedia&&"not all"!==window.matchMedia("(prefers-color-scheme)").media,o="hw-appearance",a(i=localStorage.getItem(o)||"auto"),e?(t.querySelector("[name=hw-appearance][value=auto]").parentNode.hidden=!1,t.querySelector("[name=hw-appearance][value="+i+"]").checked=!0):(/(light|dark)/i.test(i)||(i="light"),t.querySelector('[name=hw-appearance][value="'+i+'"]').checked=!0),t.onclick=function(){var e=t.querySelector("[name=hw-appearance]:checked").value
;localStorage.setItem(o,e),a(e)})}s?e():setTimeout(e,1e3)},e.hw=T,ruto.config({before:function(e,t){T.hideAllViews();var n=d("view-"+t);n.classList.remove("hidden"),T.currentView=t,T.setTitle(n.querySelector("header h1").textContent)},notfound:function(){ruto.go("/")}}).add("/","home").add("/about","about").add(/^\/item\/(\d+)$/i,"comments",function(e,t){T.comments.render(t)})}(window),function(n){function l(e){var t=e.in,n=e.out,o=t.classList,i=n.classList,r=e.direction,a=e.fn,s=d[r],
