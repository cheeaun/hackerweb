...
"meta-color-scheme"),e=window.matchMedia&&"not all"!==window.matchMedia("(prefers-color-scheme)").media,i="hw-appearance",s(r=localStorage.getItem(i)||"auto"),e?(n.querySelector("[name=hw-appearance][value=auto]").parentNode.hidden=!1,n.querySelector("[name=hw-appearance][value="+r+"]").checked=!0):(/(light|dark)/i.test(r)||(r="light"),n.querySelector('[name=hw-appearance][value="'+r+'"]').checked=!0),n.onclick=function(){var e=n.querySelector("[name=hw-appearance]:checked").value
