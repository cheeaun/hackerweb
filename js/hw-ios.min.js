!function(t){function e(){}function n(){var e=location.hash.slice(1),t=!1,n=d.current,e=e||f.defaultPath;n&&n!=d.previous&&(d.previous=n),d.current=e;for(var o=0,i=u.length;o<i&&!t;o++){var r,a=u[o],s=a.path,l=a.name,c=a.fn;"string"==typeof s?s.toLowerCase()==e.toLowerCase()&&(f.before.call(d,s,l),c.call(d),f.on.call(d,s,l),t=!0):(r=e.match(s))&&(f.before.call(d,s,l,r),c.apply(d,r),f.on.call(d,s,l,r),t=!0)}return t||f.notfound.call(d),d}var u=[],f={defaultPath:"/",before:e,on:e,notfound:e},d={
current:null,previous:null,config:function(e){for(var t in e)e.hasOwnProperty(t)&&(f[t]=e[t]);return d},add:function(e,t,n){return e&&t&&("function"==typeof t&&(n=t,t=null),u.push({path:e,name:t,fn:n||function(){}})),d},go:function(e){return location.hash=e,d},back:function(e){return d.previous?(history.back(),d.previous=null):e&&(location.hash=e),d}};d.init=function(e){return t.addEventListener("hashchange",n),n()},d.reload=n,t.ruto=d}(window),function(e,d){var p=e.store=function(e,t,n){
var o=p.type;return n&&n.type&&n.type in p.types&&(o=n.type),p.types[o](e,t,n||{})};p.types={},p.type=null,p.addType=function(o,e){p.type||(p.type=o),p.types[o]=e,p[o]=function(e,t,n){return(n=n||{}).type=o,p(e,t,n)}},p.error=function(){return"amplify.store quota exceeded"};var o,i,f=/^__amplify__/;function t(c,u){p.addType(c,function(t,e,n){var o,i,r,a,s=e,l=(new Date).getTime();if(!t){s={},a=[],r=0;try{for(t=u.length;t=u.key(r++);)f.test(t)&&((i=JSON.parse(u.getItem(t))
).expires&&i.expires<=l?a.push(t):s[t.replace(f,"")]=i.data);for(;t=a.pop();)u.removeItem(t)}catch(e){}return s}if(t="__amplify__"+t,e===d){if(!((i=(o=u.getItem(t))?JSON.parse(o):{expires:-1}).expires&&i.expires<=l))return i.data;u.removeItem(t)}else if(null===e)u.removeItem(t);else{i=JSON.stringify({data:e,expires:n.expires?l+n.expires:null});try{u.setItem(t,i)}catch(e){p[c]();try{u.setItem(t,i)}catch(e){throw p.error()}}}return s})}for(var n in{localStorage:1,sessionStorage:1})try{
window[n].setItem("__amplify__","x"),window[n].removeItem("__amplify__"),t(n,window[n])}catch(e){}if(!p.types.localStorage&&window.globalStorage)try{t("globalStorage",window.globalStorage[window.location.hostname]),"sessionStorage"===p.type&&(p.type="globalStorage")}catch(e){}function r(e){return e===d?d:JSON.parse(JSON.stringify(e))}!function(){if(!p.types.localStorage){var u=document.createElement("div"),f="amplify";u.style.display="none",document.getElementsByTagName("head")[0].appendChild(u)
;try{u.addBehavior("#default#userdata"),u.load(f)}catch(e){return u.parentNode.removeChild(u)}p.addType("userData",function(t,e,n){u.load(f);var o,i,r,a,s,l=e,c=(new Date).getTime();if(!t){for(l={},s=[],a=0;o=u.XMLDocument.documentElement.attributes[a++];)(i=JSON.parse(o.value)).expires&&i.expires<=c?s.push(o.name):l[o.name]=i.data;for(;t=s.pop();)u.removeAttribute(t);return u.save(f),l}if(t=(t=t.replace(
/[^\-._0-9A-Za-z\xb7\xc0-\xd6\xd8-\xf6\xf8-\u037d\u037f-\u1fff\u200c-\u200d\u203f\u2040\u2070-\u218f]/g,"-")).replace(/^-/,"_-"),e===d){if(!((i=(o=u.getAttribute(t))?JSON.parse(o):{expires:-1}).expires&&i.expires<=c))return i.data;u.removeAttribute(t)}else null===e?u.removeAttribute(t):(r=u.getAttribute(t),i=JSON.stringify({data:e,expires:n.expires?c+n.expires:null}),u.setAttribute(t,i));try{u.save(f)}catch(e){null===r?u.removeAttribute(t):u.setAttribute(t,r),p.userData();try{u.setAttribute(t,i)
,u.save(f)}catch(e){throw null===r?u.removeAttribute(t):u.setAttribute(t,r),p.error()}}return l})}}(),o={},i={},p.addType("memory",function(e,t,n){return e?t===d?r(o[e]):(i[e]&&(clearTimeout(i[e]),delete i[e]),null===t?(delete o[e],null):(o[e]=t,n.expires&&(i[e]=setTimeout(function(){delete o[e],delete i[e]},n.expires)),t)):r(o)})}(this.amplify=this.amplify||{});var Hogan={};!function(e){function u(e,t,n){var o;return t&&"object"==typeof t&&(
...
},sub:function(e,t,n,o){var i=this.subs[e];i&&(this.activeSub=e,i(t,n,this,o),this.activeSub=!1)}};var t=/&/g,n=/</g,o=/>/g,i=/\'/g,r=/\"/g,a=/[&<>\"\']/;function s(e){return String(null==e?"":e)}var f=Array.isArray||function(e){return"[object Array]"===Object.prototype.toString.call(e)}}("undefined"!=typeof exports?exports:Hogan),function(s){var l=!!s.XDomainRequest,c="withCredentials"in new XMLHttpRequest||l,u=!1,f={};try{(u=new Worker("js/hnapi-worker.js")).addEventListener("message",
function(e){var t,n,o,i=e.data,r=i.url||"";f[r]&&(n=(t=f[r]).error,o=t.success,delete f[r],i.error?n(i.error):o(i.response))},!1)}catch(e){}function r(t,e,n){var o,i,r,a;e=e||function(){},n=n||function(){},c?u?(f[t]={success:e,error:n},u.postMessage({url:t,timeout:2e4})):((o=f[t]||new(l?XDomainRequest:XMLHttpRequest))._timeout&&clearTimeout(o._timeout),o._timeout=setTimeout(function(){o.abort()},2e4),o.onload=function(){clearTimeout(this._timeout),delete f[t];try{e(JSON.parse(this.responseText))
}catch(e){n(e)}},o.onerror=o.onabort=o.ontimeout=function(e){clearTimeout(this._timeout),delete f[t],n(e)},(o.readyState<=1||l)&&(o.open("GET",t,!0),o.send()),f[t]=o):(r=(i=s.document).createElement("script"),a="callback"+ +new Date,s[a]=e,r.onerror=n,r.src=t+"?callback="+a,i.body.appendChild(r))}var a=["https://node-hnapi-eu.herokuapp.com/","https://node-hnapi.azurewebsites.net/","https://node-hnapi-eus.azurewebsites.net/"];!function(e){for(var t=e.length-1;0<t;t--){var n=Math.floor(
Math.random()*(t+1)),o=e[t];e[t]=e[n],e[n]=o}}(a),a.unshift("https://api.hackerwebapp.com/");function o(e,t,n){r(a[0]+e,t,function(){p(0,e,t,n)})}var d=a.length,p=function(e,t,n,o){var i=e<d-1?function(){p(e+1,t,n,o)}:o;r(a[e]+t,n,i)},e={urls:a,news:function(e,t){o("news",e,t)},news2:function(e,t){o("news2",e,t)},item:function(e,t,n){o("item/"+e,t,n)},comments:function(e,t,n){o("comments/"+e,t,n)}};s.hnapi=e}(window),function(e,t){"function"==typeof define&&define.amd?define("tappable",[],
function(){return t(e,window.document),e.tappable}):t(e,window.document)}(this,function(e,_){function t(){}function M(e,t){var n=_.elementFromPoint(e,t);return 3==n.nodeType&&(n=n.parentNode),n}function n(e){return e.replace(/\s+/g," ").replace(/^\s+|\s+$/g,"")}function x(e,t){t&&(e.classList?e.classList.add(t):-1<n(e.className).indexOf(t)||(e.className=n(e.className+" "+t)))}function I(e,t){t&&(e.classList?e.classList.remove(t):e.className=e.className.replace(new RegExp("(^|\\s)"+t+"(?:\\s|$)")
,"$1"))}function N(e,t){for(var n,o,i,r=!1;n=e,o=t,!(r=((i=_.documentElement).matchesSelector||i.mozMatchesSelector||i.webkitMatchesSelector||i.oMatchesSelector||i.msMatchesSelector).call(n,o))&&(e=e.parentNode)&&e.ownerDocument;);return!!r&&e}var C=Math.abs,A={noScroll:!1,activeClass:"tappable-active",onTap:t,onStart:t,onMove:t,onMoveOut:t,onMoveIn:t,onEnd:t,onCancel:t,allowClick:!1,boundMargin:50,noScrollDelay:0,activeClassDelay:0,inactiveClassDelay:0},o="ontouchend"in document,q={
start:o?"touchstart":"mousedown",move:o?"touchmove":"mousemove",end:o?"touchend":"mouseup"};e.tappable=function(o,e){"function"==typeof e&&(e={onTap:e});var r={};for(var t in A)r[t]=e[t]||A[t];function n(e){var t,n=N(function(e){var t=e.target;if(t)return 3==t.nodeType&&(t=t.parentNode),t;var n=e.targetTouches[0];return M(n.clientX,n.clientY)}(e),o);n&&(T?(clearTimeout(m),m=setTimeout(function(){x(n,g)},T)):x(n,g),E&&n==u&&clearTimeout(h),f=e.clientX,d=e.clientY,f&&d||(t=e.targetTouches[0],
f=t.clientX,d=t.clientY),c=n,y=w=!1,p=S?n.getBoundingClientRect():null,k&&(clearTimeout(v),S=!1,v=setTimeout(function(){S=!0},k)),r.onStart.call(b,e,n))}function i(e){var t,n,o,i;c&&(S?e.preventDefault():clearTimeout(m),i=e.target,n=e.clientX,o=e.clientY,i&&n&&o||(t=e.changedTouches[0],n=n||t.clientX,o=o||t.clientY,i=i||M(n,o)),S?n>p.left-L&&n<p.right+L&&o>p.top-L&&o<p.bottom+L?(y=!1,x(c,g),r.onMoveIn.call(b,e,i)):(y=!0,I(c,g),r.onMoveOut.call(b,e,i)):!w&&10<C(o-d)&&(w=!0,I(c,g),r.onCancel.call(
i,e)),r.onMove.call(b,e,i))}function a(e){var t,n;c&&(clearTimeout(m),E?(T&&!w&&x(c,g),t=c,h=setTimeout(function(){I(t,g)},E)):I(c,g),r.onEnd.call(b,e,c),n=3==e.which||2==e.button,w||y||n||r.onTap.call(b,e,c),u=c,c=null,setTimeout(function(){f=d=null},400))}function s(e){c&&(I(c,g),c=f=d=null,r.onCancel.call(b,e))}function l(e){N(e.target,o)?e.preventDefault():f&&d&&C(e.clientX-f)<25&&C(e.clientY-d)<25&&(e.stopPropagation(),e.preventDefault())}var c,u,f,d,p,m,h,v,b=r.containerElement||_.body,
w=!1,y=!1,g=r.activeClass,T=r.activeClassDelay,E=r.inactiveClassDelay,S=r.noScroll,k=r.noScrollDelay,L=r.boundMargin;return b.addEventListener(q.start,n,!1),b.addEventListener(q.move,i,!1),b.addEventListener(q.end,a,!1),b.addEventListener("touchcancel",s,!1),r.allowClick||b.addEventListener("click",l,!1),{el:b,destroy:function(){return b.removeEventListener(q.start,n,!1),b.removeEventListener(q.move,i,!1),b.removeEventListener(q.end,a,!1),b.removeEventListener("touchcancel",s,!1),
...
},add:function(e){n.push(e)},remove:function(e){var t=n.indexOf(e);-1!==t&&n.splice(t,1)},update:function(e){if(0===n.length)return!1;var t=0;for(e=void 0!==e?e:window.performance.now();t<n.length;)n[t].update(e)?t++:n.splice(t,1);return!0}}}();TWEEN.Tween=function(e){var c=e,u={},f={},d={},p=1e3,m=0,h=!1,n=!1,v=0,b=null,w=TWEEN.Easing.Linear.None,y=TWEEN.Interpolation.Linear,g=[],T=null,E=!1,S=null,k=null,t=null;for(var o in e)u[o]=parseFloat(e[o],10);this.to=function(e,t){return void 0!==t&&(
p=t),f=e,this},this.start=function(e){for(var t in TWEEN.add(this),E=!(n=!0),b=void 0!==e?e:window.performance.now(),b+=v,f){if(f[t]instanceof Array){if(0===f[t].length)continue;f[t]=[c[t]].concat(f[t])}void 0!==u[t]&&(u[t]=c[t],u[t]instanceof Array==!1&&(u[t]*=1),d[t]=u[t]||0)}return this},this.stop=function(){return n&&(TWEEN.remove(this),n=!1,null!==t&&t.call(c),this.stopChainedTweens()),this},this.stopChainedTweens=function(){for(var e=0,t=g.length;e<t;e++)g[e].stop()},this.delay=function(e
...
E=!0),o=w(n=1<(n=(e-b)/p)?1:n),f){void 0!==u[t]&&(i=u[t]||0,(r=f[t])instanceof Array?c[t]=y(r,o):("string"==typeof r&&(r=r.startsWith("+")||r.startsWith("-")?i+parseFloat(r,10):parseFloat(r,10)),"number"==typeof r&&(c[t]=i+(r-i)*o)))}if(null!==S&&S.call(c,o),1!==n)return!0;if(0<m){for(t in isFinite(m)&&m--,d){"string"==typeof f[t]&&(d[t]=d[t]+parseFloat(f[t],10)),h&&(a=d[t],d[t]=f[t],f[t]=a),u[t]=d[t]}return h&&0,b=e+v,!0}null!==k&&k.call(c);for(var s=0,l=g.length;s<l;s++)g[s].start(b+p)
...
var o=this;return o.b(n=n||""),o.s(o.f("loading",e,t,1),e,t,0,12,82,"{{ }}")&&(o.rs(e,t,function(e,t,n){n.b('<div class="loader"><i class="icon-loading"></i> Loading&hellip;</div>')}),e.pop()),o.s(o.f("load_error",e,t,1),e,t,0,109,161,"{{ }}")&&(o.rs(e,t,function(e,t,n){n.b('<div class="load-error">Couldn\'t load stories.</div>')}),e.pop()),o.fl()},partials:{},subs:{}})}}(Hogan.Template),function(e){var g=e.document,f=e.$=function(e){return g.getElementById(e)},r={},T={pub:function(e,t){
var n=r[e];if(n)for(var o=0,i=n.length;o<i;o++)n[o].call(this,t)},sub:function(e,t){r[e]||(r[e]=[]),r[e].push(t)},currentView:null,hideAllViews:function(){for(var e=g.querySelectorAll(".view"),t=0,n=e.length;t<n;t++)e[t].classList.add("hidden")},tmpl:function(e,t){var n=TEMPLATES[e];if(n)return t?n.render(t):n},setTitle:function(e){var t="HackerWeb";e&&(e=e.replace(/^\s+|\s+$/g,"")).toLowerCase()!=t.toLowerCase()&&(t=e+" – "+t),document.title=t}};"undefined"!=typeof ga&&T.sub("logAPIError",
function(e){ga("send","event","Errors","API",e)});var E=T.tmpl;amplify.store.sessionStorage&&"function"==typeof amplify.store.sessionStorage||(amplify.store.sessionStorage=amplify.store.memory);function S(e){if(i=s[e])return i;a.href=e;var t=a.hostname.replace(/^www\./,""),n=a.pathname.replace(/^\//,"").split("/")[0],o=n.length,i=t+(t.length<=25&&3<o&&o<=15&&/^[^0-9][^.]+$/.test(n)?"/"+n:"");return s[e]=i}var a=g.createElement("a"),s={},l=g.querySelector("#view-home .scroll").querySelector(
"section"),c=!1;T.news={options:{disclosure:!0},markupStory:function(e){return/^item/i.test(e.url)?e.url="#/item/"+e.id:(e.external=!0,e.domain=S(e.url)),T.news.options.disclosure?("link"==e.type&&(e.detail_disclosure=!0),/^#\//.test(e.url)&&(e.detail_disclosure=!1,e.disclosure=!0,e.domain=null)):e.id&&(e.url="#/item/"+e.id),e.i_point=1==e.points?"point":"points",e.i_comment=1==e.comments_count?"comment":"comments",E("post",e)},markupStories:function(e,t){var n="";t=t||1;var o=T.news.markupStory
;return e.forEach(function(e){e.i=t++,n+=o(e)}),n},updateStory:function(e){if(e&&e.id){var n,o,t,i=e.id,r=e.data,a="hacker-news",s=amplify.store(a);if(s)for(var l=0,c=s.length;l<c;l++){if(i==(u=s[l]).id){n=u;break}}if(!n&&(a="hacker-news2",s=amplify.store(a)))for(var u,l=0,c=s.length;l<c;l++){if(i==(u=s[l]).id){n=u;break}}n&&(o=!1,["title","url","time_ago","comments_count","points"].forEach(function(e){var t=r[e];n[e]!=t&&(n[e]=t,o=!0)}),o&&(amplify.store(a,s),(t=f("story-"+i))&&(
n.selected=!!t.querySelector("a[href].selected"),n.i=t.dataset?t.dataset.index:t.getAttribute("data-index"),t.insertAdjacentHTML("afterend",T.news.markupStory(n)),t.parentNode.removeChild(t))))}},render:function(e){var t,n,o,i,r,a;c||(e=e||{},t=amplify.store("hacker-news-cached"),n=E("stories-load"),o=function(e){var t=e.slice(),n='<ul class="tableview tableview-links" id="hwlist">'+T.news.markupStories(t)+(amplify.store("hacker-news2"
)?'<li><a class="more-link">More&hellip;<span class="loader"><i class="icon-loading"></i></span></a></li>':"")+"</ul>";l.innerHTML=n,T.pub("onRenderNews")},t?(i=amplify.store("hacker-news"),(r=e.delay)?(c=!0,l.innerHTML=n.render({loading:!0}),setTimeout(function(){c=!1,o(i)},r)):o(i)):(c=!0,l.innerHTML=n.render({loading:!0}),a=function(){l.innerHTML=n.render({load_error:!0}),T.pub("logAPIError","news")},hnapi.news(function(e){c=!1,e&&!e.error?(amplify.store("hacker-news",e),amplify.store(
"hacker-news-cached",!0,{expires:6e5}),amplify.store("hacker-news2",null),o(e),hnapi.news2(function(e){e&&!e.error&&(amplify.store("hacker-news2",e),f("hwlist").insertAdjacentHTML("beforeend",'<li><a class="more-link">More&hellip;<span class="loader"></span></a></li>'))})):a()},function(e){c=!1,a()})))},reload:function(){T.news.render({delay:300})},more:function(o){var i;o.classList.contains("loading")||(o.classList.add("loading"),i=amplify.store("hacker-news2"),setTimeout(function(){
o.classList.remove("loading");var e,t,n=o.parentNode;n&&(n.parentNode&&n.parentNode.removeChild(n),i&&(e=i.slice(),t=T.news.markupStories(e,31),f("hwlist").insertAdjacentHTML("beforeend",t)))},400))}};var t=f("view-comments"),k=t.querySelector("header h1"),L=t.querySelector("section");T.comments={currentID:null,render:function(t){if(t){var e=amplify.store.sessionStorage("hacker-item-"+t);if(T.comments.currentID!=t||!e){T.comments.currentID=t;function n(e,t){var n=function(e){var t={};for(
var n in e)e.hasOwnProperty(n)&&(t[n]=e[n]);return t}(e),o=E("post-comments");if(n.has_post=!!n.title,!n.has_post)return T.setTitle(),k.innerHTML="",L.innerHTML=o.render(n),T.pub("adjustCommentsSection"),void T.pub("onRenderComments");var i,r,a=E("comments");/^item/i.test(n.url)?n.url="//news.ycombinator.com/"+n.url:n.domain=S(n.url),n.has_comments=n.comments&&!!n.comments.length,n.i_point=1==n.points?"point":"points",n.i_comment=1==n.comments_count?"comment":"comments",n.has_content=!!n.content
,n.poll&&(r=i=0,n.poll.forEach(function(e){var t=e.points;r<t&&(r=t),i+=t,e.i_point=1==t?"point":"points"}),n.poll.forEach(function(e){var t=e.points;e.percentage=(t/i*100).toFixed(1),e.width=(t/r*100).toFixed(1)+"%"}),n.has_poll=n.has_content=!0),n.short_hn_url="news.ycombinator.com/item?id="+t,n.hn_url="//"+n.short_hn_url,T.setTitle(n.title),k.innerHTML=n.title;var s=o.render(n,{comments_list:a}),l=g.createElement("div");l.innerHTML=s;for(var c=l.querySelectorAll("a"),u=0,f=c.length;u<f;u++){
c[u].target="_blank"}var d=n.user;if(d)for(var p=l.querySelectorAll(".user"),u=0,f=p.length;u<f;u++){var m=p[u];m.textContent.trim()==d&&(m.classList.add("op"),m.title="Original Poster")}if(2e4<s.length)for(var h=l.querySelectorAll(".comments>ul>li>ul"),v=E("comments-toggle"),b=0,f=h.length;b<f;b++){var w=h[b],y=w.querySelectorAll(".metadata").length;w.style.display="none",y&&w.insertAdjacentHTML("beforebegin",v.render({comments_count:y,i_reply:1==y?"reply":"replies"}))}for(;L.hasChildNodes();
)L.removeChild(L.childNodes[0]);for(;l.hasChildNodes();)L.appendChild(l.childNodes[0]);delete l,T.pub("onRenderComments")}if(e)L.scrollTop=0,n(e,t);else{var o=amplify.store("hacker-news");if(o)for(var i=0,r=o.length;i<r;i++){var a=o[i];if(t==a.id){e=a;break}}if(!e)if(o=amplify.store("hacker-news2"))for(i=0,r=o.length;i<r;i++){a=o[i];if(t==a.id){e=a;break}}e?(e.loading=!0,n(e,t)):n({loading:!0},t);function s(){e?(delete e.loading,e.load_error=!0,n(e,t)):n({load_error:!0},t),T.pub("logAPIError",
"comments")}hnapi.item(t,function(e){T.comments.currentID==t&&(!e||e.error&&"comments"==T.currentView?s():(amplify.store.sessionStorage("hacker-item-"+t,e,{expires:3e5}),T.news.updateStory({id:t,data:e}),n(e,t)))},function(e){T.comments.currentID==t&&s()})}}}},toggle:function(e){var t,n,o=e.nextElementSibling;o&&(t=o.style,n=L.scrollTop,t.display="none"==t.display?"":"none",L.scrollTop=n)},reload:function(){T.comments.currentID=null,ruto.reload()}},T.init=function(){T.news.render(),ruto.init()},
e.hw=T,ruto.config({before:function(e,t){T.hideAllViews();var n=f("view-"+t);n.classList.remove("hidden"),T.currentView=t,T.setTitle(n.querySelector("header h1").textContent)},notfound:function(){ruto.go("/")}}).add("/","home").add("/about","about").add(/^\/item\/(\d+)$/i,"comments",function(e,t){T.comments.render(t)})}(window),function(n){function l(e){var t=e.in,n=e.out,o=t.classList,i=n.classList,r=e.direction,a=e.fn,s=f[r],l=function(){t.removeEventListener("webkitAnimationEnd",l,!1),
u.classList.remove("viewport-flip"),i.add("hidden"),o.remove("flip"),i.remove("flip"),i.remove(s[0]),o.remove(s[1]),a&&a.apply()};u.classList.add("viewport-flip"),o.remove("hidden"),i.add("flip"),o.add("flip"),t.addEventListener("webkitAnimationEnd",l,!1),i.add(s[0]),o.add(s[1])}function c(e){var t=e.in,n=e.out,o=t.classList,i=n.classList,r=t.getElementsByTagName("header")[0],a=n.getElementsByTagName("header")[0],s=r.classList,l=a.classList,c=e.direction,u=e.fn,f=p[c],d=function(){i.add("hidden"
),t.removeEventListener("webkitAnimationEnd",d,!1),i.remove("sliding"),o.remove("sliding"),i.remove(f[0]),o.remove(f[1]),s.remove("transparent"),l.remove("transparent"),u&&u.apply()};o.remove("hidden"),i.add("sliding"),o.add("sliding"),t.addEventListener("webkitAnimationEnd",d,!1),s.add("transparent"),l.add("transparent"),i.add(f[0]),o.add(f[1])}function t(){return 640<=n.innerWidth?"wide":"narrow"}var r=n.document,u=r.body,f={clockwise:["flip-out-to-left","flip-in-from-left"],anticlockwise:[
"flip-out-to-right","flip-in-from-right"]},p={rtl:["slide-out-to-left","slide-in-from-right"],ltr:["slide-out-to-right","slide-in-from-left"]},e=r.querySelector("meta[name=viewport]");e||((e=r.createElement("meta")).name="viewport",r.head.appendChild(e)),e.content="width=device-width, initial-scale=1.0, user-scalable=0, minimum-scale=1.0, maximum-scale=1.0";var o=navigator.userAgent,a=o&&/iPhone|iPod/.test(o),i=parseInt((o.match(/ OS (\d+)_/i)||[,0])[1],10)<6;a&&i&&u.classList.add("ios5")
;var d="wide"==t();n.addEventListener("resize",function(){var e="wide"==t();e!=d&&(d=e,location.reload())}),u.insertAdjacentHTML("beforeend",d?'<div id="overlay" class="hide"></div>':'<header class="fake"></header>'),ruto.config({before:function(e,t,n){var o,i,r=hw.currentView,a=hw.hideAllViews,s=$("view-"+t);switch(hw.setTitle(s.querySelector("header h1").textContent),t){case"home":d?(a(),$("overlay").classList.add("hide"),s.classList.remove("hidden"),(o=$("view-comments")).classList.remove(
"hidden"),o.querySelector("section").innerHTML='<div class="view-blank-state"><div class="view-blank-state-text">No Story Selected.</div></div>',o.querySelector("header h1").innerHTML="",o.querySelector("header a.header-back-button").style.display="none",hw.comments.currentID=null,hw.pub("selectCurrentStory")):r?"about"==r?l({in:s,out:$("view-"+r),direction:"anticlockwise"}):"home"!=r&&c({in:s,out:$("view-"+r),direction:"ltr"}):(a(),s.classList.remove("hidden")),hw.currentView="home";break
;case"about":d?(s.classList.remove("hidden"),$("view-home").classList.remove("hidden"),$("view-comments").classList.remove("hidden"),setTimeout(function(){$("overlay").classList.remove("hide")},1)):r?"about"!=r&&l({in:s,out:$("view-home"),direction:"clockwise"}):(a(),s.classList.remove("hidden")),hw.currentView="about";break;case"comments":d?(a(),$("overlay").classList.add("hide"),s.classList.remove("hidden"),$("view-home").classList.remove("hidden"),hw.pub("selectCurrentStory",n[1]),
s.querySelector("header a.header-back-button").style.display=""):r?"comments"!=r&&((i=n[1])&&hw.comments.currentID!=i&&(s.querySelector("section").scrollTop=0),c({in:s,out:$("view-"+r),direction:"rtl"})):(a(),s.classList.remove("hidden")),hw.currentView="comments"}}}),n.addEventListener("pagehide",function(){for(var e=r.querySelectorAll(".view"),t={},n=0,o=e.length;n<o;n++){var i=e[n];t[i.id]=i.querySelector(".scroll section").scrollTop||0}amplify.store("hacker-scrolltops",t)},!1);function s(){
var t=amplify.store("hacker-scrolltops");setTimeout(function(){for(var e in t)$(e).querySelector(".scroll section").scrollTop=t[e]},1)}var m,h;n.addEventListener("pageshow",s,!1),s(),a&&(m=r.querySelectorAll(".view>.scroll"),h=null,Array.prototype.forEach.call(m,function(e){e.addEventListener("touchstart",function(){var e;n.innerHeight!=h&&(n.scrollTo(0,0),i&&((e=r.createElement("div")).style.height="600px",u.appendChild(e),setTimeout(function(){u.removeChild(e)},100)),h=n.innerHeight)},!1)})),
tappable(".view>header a.header-button[href]",{noScroll:!0,onTap:function(e,t){var n=t.hash;d&&/about/i.test(ruto.current)&&"#/"==n?ruto.back("/"):location.hash=n}}),tappable("#view-home-refresh",{noScroll:!0,onTap:hw.news.reload});var v,b=!1;tappable(".view>header h1",{onTap:function(e,t){var n,o=t.parentNode.nextElementSibling.firstElementChild;if(0==o.scrollTop||b){a&&(n=u.style.height,u.style.height="100%",setTimeout(function(){u.style.height=n},100))}else{if(b)return;b=!0
;var i=o.style.overflow;o.style.overflow="hidden",setTimeout(function(){o.style.overflow=i;var e=new TWEEN.Tween({scrollTop:o.scrollTop}).to({scrollTop:0},300).easing(TWEEN.Easing.Cubic.InOut).onUpdate(function(){o.scrollTop=this.scrollTop}).onComplete(function(){cancelAnimationFrame(n),e.stop(),b=!1,delete e}).start(),t=function(){TWEEN.update(),requestAnimationFrame(t)},n=requestAnimationFrame(t)},200)}}}),tappable("#view-home .tableview-links li>a:first-child",{allowClick:!d,
activeClassDelay:100,inactiveClassDelay:d?100:1e3,onStart:function(e,t){var n;!d||(n=t.parentNode)&&(n=n.parentNode,v=setTimeout(function(){n&&n.classList.add("list-tapped")},100))},onMove:function(){d&&clearTimeout(v)},onEnd:function(e,t){var n;d&&(clearTimeout(v),n=t.parentNode.parentNode,setTimeout(function(){n&&n.classList.remove("list-tapped")},100))},onTap:function(e,t){t.classList.contains("more-link")?hw.news.more(t):/^#\//.test(t.getAttribute("href")
)?location.hash=t.hash:t.href&&d&&n.open(t.href)}}),tappable("#view-about .grouped-tableview-links li>a:first-child",{allowClick:!0,activeClassDelay:100,inactiveClassDelay:1e3}),tappable("#view-home .tableview-links li>a.detail-disclosure-button",{noScroll:!0,noScrollDelay:100,onTap:function(e,t){location.hash=t.hash}}),tappable("button.comments-toggle",function(e,t){hw.comments.toggle(t)}),tappable("#view-comments .load-error button",hw.comments.reload),hw.sub("selectCurrentStory",function(e){
if(d){e=e||(location.hash.match(/item\/(\d+)/)||[,""])[1];for(var t,n=$("view-home"),o=n.querySelectorAll("a[href].selected"),i=0,r=o.length;i<r;i++)o[i].classList.remove("selected");!e||(t=n.querySelector('a[href*="item/'+e+'"]'))&&(t.classList.add("selected"),setTimeout(function(){t.scrollIntoViewIfNeeded?t.scrollIntoViewIfNeeded():t.scrollIntoView()},1))}}),hw.sub("onRenderNews",function(){hw.pub("selectCurrentStory")}),n.addEventListener("pageshow",function(){setTimeout(function(){
"home"==hw.currentView&&$("hwlist")&&!amplify.store("hacker-news-cached")&&hw.news.reload()},1)},!1);function w(){var e,t,n,o=r.querySelector("#view-comments section");o&&(e=o.querySelector(".post-content"),o.querySelector(".comments")&&(t=o.offsetHeight-e.offsetHeight+1,(n=$("comment-section-style"))||((n=r.createElement("style")).id="comment-section-style",r.head.appendChild(n)),n.textContent=".view section.comments{min-height: "+t+"px;}"))}hw.sub("onRenderComments",function(){setTimeout(w,
d?1:360)}),n.addEventListener("resize",w,!1),n.addEventListener("orientationchange",w,!1);function y(){g&&(u.style.height=screen.height+"px",setTimeout(function(){n.scrollTo(0,0),u.style.height=n.innerHeight+"px"},1))}var g=void 0!==n.orientation;d||("complete"==r.readyState?y():n.addEventListener("load",y,!1),g&&(n.onorientationchange=y)),hw.news.options.disclosure=!d,hw.init()}(window);
