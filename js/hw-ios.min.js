...
,"$1"))}function I(e,t){for(var n,o,i,r=!1;n=e,o=t,!(r=((i=_.documentElement).matchesSelector||i.mozMatchesSelector||i.webkitMatchesSelector||i.oMatchesSelector||i.msMatchesSelector).call(n,o))&&(e=e.parentNode)&&e.ownerDocument;);return!!r&&e}var C=Math.abs,A={noScroll:!1,activeClass:"tappable-active",onTap:t,onStart:t,onMove:t,onMoveOut:t,onMoveIn:t,onEnd:t,onCancel:t,allowClick:!1,boundMargin:50,noScrollDelay:0,activeClassDelay:0,inactiveClassDelay:0},o="ontouchend"in document,q={
start:o?"touchstart":"mousedown",move:o?"touchmove":"mousemove",end:o?"touchend":"mouseup"};e.tappable=function(o,e){"function"==typeof e&&(e={onTap:e});var r={};for(var t in A)r[t]=e[t]||A[t];function n(e){var t,n=I(function(e){var t=e.target;if(t)return 3==t.nodeType&&(t=t.parentNode),t;var n=e.targetTouches[0];return x(n.clientX,n.clientY)}(e),o);n&&(T?(clearTimeout(m),m=setTimeout(function(){M(n,y)},T)):M(n,y),E&&n==u&&clearTimeout(h),d=e.clientX,f=e.clientY,d&&f||(t=e.targetTouches[0],
d=t.clientX,f=t.clientY),c=n,g=w=!1,p=S?n.getBoundingClientRect():null,k&&(clearTimeout(v),S=!1,v=setTimeout(function(){S=!0},k)),r.onStart.call(b,e,n))}function i(e){var t,n,o,i;c&&(S?e.preventDefault():clearTimeout(m),i=e.target,n=e.clientX,o=e.clientY,i&&n&&o||(t=e.changedTouches[0],n=n||t.clientX,o=o||t.clientY,i=i||x(n,o)),S?n>p.left-L&&n<p.right+L&&o>p.top-L&&o<p.bottom+L?(g=!1,M(c,y),r.onMoveIn.call(b,e,i)):(g=!0,N(c,y),r.onMoveOut.call(b,e,i)):!w&&10<C(o-f)&&(w=!0,N(c,y),r.onCancel.call(
i,e)),r.onMove.call(b,e,i))}function a(e){var t,n;c&&(clearTimeout(m),E?(T&&!w&&M(c,y),t=c,h=setTimeout(function(){N(t,y)},E)):N(c,y),r.onEnd.call(b,e,c),n=3==e.which||2==e.button,w||g||n||r.onTap.call(b,e,c),u=c,c=null,setTimeout(function(){d=f=null},400))}function s(e){c&&(N(c,y),c=d=f=null,r.onCancel.call(b,e))}function l(e){I(e.target,o)?e.preventDefault():d&&f&&C(e.clientX-d)<25&&C(e.clientY-f)<25&&(e.stopPropagation(),e.preventDefault())}var c,u,d,f,p,m,h,v,b=r.containerElement||_.body,
w=!1,g=!1,y=r.activeClass,T=r.activeClassDelay,E=r.inactiveClassDelay,S=r.noScroll,k=r.noScrollDelay,L=r.boundMargin;return b.addEventListener(q.start,n,!1),b.addEventListener(q.move,i,!1),b.addEventListener(q.end,a,!1),b.addEventListener("touchcancel",s,!1),r.allowClick||b.addEventListener("click",l,!1),{el:b,destroy:function(){return b.removeEventListener(q.start,n,!1),b.removeEventListener(q.move,i,!1),b.removeEventListener(q.end,a,!1),b.removeEventListener("touchcancel",s,!1),
...
},add:function(e){n.push(e)},remove:function(e){var t=n.indexOf(e);-1!==t&&n.splice(t,1)},update:function(e){if(0===n.length)return!1;var t=0;for(e=void 0!==e?e:window.performance.now();t<n.length;)n[t].update(e)?t++:n.splice(t,1);return!0}}}();TWEEN.Tween=function(e){var c=e,u={},d={},f={},p=1e3,m=0,h=!1,n=!1,v=0,b=null,w=TWEEN.Easing.Linear.None,g=TWEEN.Interpolation.Linear,y=[],T=null,E=!1,S=null,k=null,t=null;for(var o in e)u[o]=parseFloat(e[o],10);this.to=function(e,t){return void 0!==t&&(
p=t),d=e,this},this.start=function(e){for(var t in TWEEN.add(this),E=!(n=!0),b=void 0!==e?e:window.performance.now(),b+=v,d){if(d[t]instanceof Array){if(0===d[t].length)continue;d[t]=[c[t]].concat(d[t])}void 0!==u[t]&&(u[t]=c[t],u[t]instanceof Array==!1&&(u[t]*=1),f[t]=u[t]||0)}return this},this.stop=function(){return n&&(TWEEN.remove(this),n=!1,null!==t&&t.call(c),this.stopChainedTweens()),this},this.stopChainedTweens=function(){for(var e=0,t=y.length;e<t;e++)y[e].stop()},this.delay=function(e
...
e.hw=T,ruto.config({before:function(e,t){T.hideAllViews();var n=d("view-"+t);n.classList.remove("hidden"),T.currentView=t,T.setTitle(n.querySelector("header h1").textContent)},notfound:function(){ruto.go("/")}}).add("/","home").add("/about","about").add(/^\/item\/(\d+)$/i,"comments",function(e,t){T.comments.render(t)})}(window),function(n){function l(e){var t=e.in,n=e.out,o=t.classList,i=n.classList,r=e.direction,a=e.fn,s=d[r],l=function(){t.removeEventListener("webkitAnimationEnd",l,!1),
u.classList.remove("viewport-flip"),i.add("hidden"),o.remove("flip"),i.remove("flip"),i.remove(s[0]),o.remove(s[1]),a&&a.apply()};u.classList.add("viewport-flip"),o.remove("hidden"),i.add("flip"),o.add("flip"),t.addEventListener("webkitAnimationEnd",l,!1),i.add(s[0]),o.add(s[1])}function c(e){var t=e.in,n=e.out,o=t.classList,i=n.classList,r=t.getElementsByTagName("header")[0],a=n.getElementsByTagName("header")[0],s=r.classList,l=a.classList,c=e.direction,u=e.fn,d=p[c],f=function(){i.add("hidden"
),t.removeEventListener("webkitAnimationEnd",f,!1),i.remove("sliding"),o.remove("sliding"),i.remove(d[0]),o.remove(d[1]),s.remove("transparent"),l.remove("transparent"),u&&u.apply()};o.remove("hidden"),i.add("sliding"),o.add("sliding"),t.addEventListener("webkitAnimationEnd",f,!1),s.add("transparent"),l.add("transparent"),i.add(d[0]),o.add(d[1])}function t(){return 640<=n.innerWidth?"wide":"narrow"}var r=n.document,u=r.body,d={clockwise:["flip-out-to-left","flip-in-from-left"],anticlockwise:[
...
f?1:360)}),n.addEventListener("resize",w,!1),n.addEventListener("orientationchange",w,!1);function g(){T&&(u.style.height=screen.height+"px",setTimeout(function(){n.scrollTo(0,0),u.style.height=n.innerHeight+"px"},1))}var y,T=void 0!==n.orientation;f?(y=$("apploader")).parentNode.removeChild(y):("complete"==r.readyState?g():n.addEventListener("load",g,!1),T&&(n.onorientationchange=g),setTimeout(function(){var e=$("apploader");e&&(e.classList.add("hide"),e.addEventListener("webkitTransitionEnd",
function(){e.parentNode.removeChild(e)},!1))},200)),hw.news.options.disclosure=!f,hw.init()}(window),WebFontConfig={google:{families:["Inconsolata"]}},function(){var e=document.createElement("script");e.src=("https:"==document.location.protocol?"https":"http")+"://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js",e.type="text/javascript",e.async="true";var t=document.getElementsByTagName("script")[0];t.parentNode.insertBefore(e,t)}();
