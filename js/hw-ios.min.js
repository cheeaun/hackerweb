...
}}}),a.addEventListener("pagehide",function(){for(var a=b.querySelectorAll(".view"),c={},d=0,e=a.length;e>d;d++){var f=a[d];c[f.id]=f.querySelector(".scroll section").scrollTop||0}amplify.store("hacker-scrolltops",c)},!1);var n=function(){var a=amplify.store("hacker-scrolltops");setTimeout(function(){for(var b in a)$(b).querySelector(".scroll section").scrollTop=a[b]},1)};if(a.addEventListener("pageshow",n,!1),n(),k){var o=b.querySelectorAll(".view>.scroll"),p=null;Array.prototype.forEach.call(o,function(d){
...
}),tappable("#view-comments .load-error button",hw.comments.reload),hw.sub("selectCurrentStory",function(a){if(m){a||(a=(location.hash.match(/item\/(\d+)/)||[,""])[1]);for(var b=$("view-home"),c=b.querySelectorAll("a[href].selected"),d=0,e=c.length;e>d;d++)c[d].classList.remove("selected");if(a){var f=b.querySelector('a[href*="item/'+a+'"]');f&&(f.classList.add("selected"),setTimeout(function(){f.scrollIntoViewIfNeeded?f.scrollIntoViewIfNeeded():f.scrollIntoView()},1))}}}),hw.sub("onRenderNews",function(){
