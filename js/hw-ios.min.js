...
,"$1"))}function N(e,t){for(var n,o,i,r=!1;n=e,o=t,i=void 0,!(r=((i=_.documentElement).matchesSelector||i.mozMatchesSelector||i.webkitMatchesSelector||i.oMatchesSelector||i.msMatchesSelector).call(n,o))&&(e=e.parentNode)&&e.ownerDocument;);return!!r&&e}var A=Math.abs,C={noScroll:!1,activeClass:"tappable-active",onTap:t,onStart:t,onMove:t,onMoveOut:t,onMoveIn:t,onEnd:t,onCancel:t,allowClick:!1,boundMargin:50,noScrollDelay:0,activeClassDelay:0,inactiveClassDelay:0},o="ontouchend"in document,q={
start:o?"touchstart":"mousedown",move:o?"touchmove":"mousemove",end:o?"touchend":"mouseup"};e.tappable=function(o,e){"function"==typeof e&&(e={onTap:e});var r={};for(var t in C)r[t]=e[t]||C[t];function n(e){var t,n=N(function(e){var t=e.target;if(t)return 3==t.nodeType&&(t=t.parentNode),t;var n=e.targetTouches[0];return x(n.clientX,n.clientY)}(e),o);n&&(T?(clearTimeout(m),m=setTimeout(function(){M(n,y)},T)):M(n,y),E&&n==u&&clearTimeout(h),d=e.clientX,f=e.clientY,d&&f||(t=e.targetTouches[0],
d=t.clientX,f=t.clientY),c=n,g=w=!1,p=k?n.getBoundingClientRect():null,S&&(clearTimeout(v),k=!1,v=setTimeout(function(){k=!0},S)),r.onStart.call(b,e,n))}function i(e){var t,n,o,i;c&&(k?e.preventDefault():clearTimeout(m),i=e.target,n=e.clientX,o=e.clientY,i&&n&&o||(t=e.changedTouches[0],n=n||t.clientX,o=o||t.clientY,i=i||x(n,o)),k?n>p.left-L&&n<p.right+L&&o>p.top-L&&o<p.bottom+L?(g=!1,M(c,y),r.onMoveIn.call(b,e,i)):(g=!0,I(c,y),r.onMoveOut.call(b,e,i)):!w&&10<A(o-f)&&(w=!0,I(c,y),r.onCancel.call(
i,e)),r.onMove.call(b,e,i))}function a(e){var t,n;c&&(clearTimeout(m),E?(T&&!w&&M(c,y),t=c,h=setTimeout(function(){I(t,y)},E)):I(c,y),r.onEnd.call(b,e,c),n=3==e.which||2==e.button,w||g||n||r.onTap.call(b,e,c),u=c,c=null,setTimeout(function(){d=f=null},400))}function s(e){c&&(I(c,y),c=d=f=null,r.onCancel.call(b,e))}function l(e){N(e.target,o)?e.preventDefault():d&&f&&A(e.clientX-d)<25&&A(e.clientY-f)<25&&(e.stopPropagation(),e.preventDefault())}var c,u,d,f,p,m,h,v,b=r.containerElement||_.body,
w=!1,g=!1,y=r.activeClass,T=r.activeClassDelay,E=r.inactiveClassDelay,k=r.noScroll,S=r.noScrollDelay,L=r.boundMargin;return b.addEventListener(q.start,n,!1),b.addEventListener(q.move,i,!1),b.addEventListener(q.end,a,!1),b.addEventListener("touchcancel",s,!1),r.allowClick||b.addEventListener("click",l,!1),{el:b,destroy:function(){return b.removeEventListener(q.start,n,!1),b.removeEventListener(q.move,i,!1),b.removeEventListener(q.end,a,!1),b.removeEventListener("touchcancel",s,!1),
...
function(e){ga("send","event","Errors","API",e)});var E=T.tmpl;amplify.store.sessionStorage&&"function"==typeof amplify.store.sessionStorage||(amplify.store.sessionStorage=amplify.store.memory);function k(e){if(i=s[e])return i;a.href=e;var t=a.hostname.replace(/^www\./,""),n=a.pathname.replace(/^\//,"").split("/")[0],o=n.length,i=t+(t.length<=25&&3<o&&o<=15&&/^[^0-9][^.]+$/.test(n)?"/"+n:"");return s[e]=i}var a=y.createElement("a"),s={},l=y.querySelector("#view-home .scroll").querySelector(
"section"),c=!1;T.news={options:{disclosure:!0},markupStory:function(e){return/^item/i.test(e.url)?e.url="#/item/"+e.id:(e.external=!0,e.domain=k(e.url)),T.news.options.disclosure?("link"==e.type&&(e.detail_disclosure=!0),/^#\//.test(e.url)&&(e.detail_disclosure=!1,e.disclosure=!0,e.domain=null)):e.id&&(e.url="#/item/"+e.id),e.i_point=1==e.points?"point":"points",e.i_comment=1==e.comments_count?"comment":"comments",E("post",e)},markupStories:function(e,t){var n="";t=t||1;var o=T.news.markupStory
...
hw.sub("selectCurrentStory",function(e){if(f){e=e||(location.hash.match(/item\/(\d+)/)||[,""])[1];for(var t,n=$("view-home"),o=n.querySelectorAll("a[href].selected"),i=0,r=o.length;i<r;i++)o[i].classList.remove("selected");!e||(t=n.querySelector('a[href*="item/'+e+'"]'))&&(t.classList.add("selected"),setTimeout(function(){t.scrollIntoViewIfNeeded?t.scrollIntoViewIfNeeded():t.scrollIntoView()},1))}}),hw.sub("onRenderNews",function(){hw.pub("selectCurrentStory")}),n.addEventListener("pageshow",
function(){setTimeout(function(){"home"==hw.currentView&&$("hwlist")&&!amplify.store("hacker-news-cached")&&hw.news.reload()},1)},!1);function w(){var e,t,n,o=r.querySelector("#view-comments section");o&&(e=o.querySelector(".post-content"),o.querySelector(".comments")&&(t=o.offsetHeight-e.offsetHeight+1,(n=$("comment-section-style"))||((n=r.createElement("style")).id="comment-section-style",r.head.appendChild(n)),n.textContent=".view section.comments{min-height: "+t+"px;}"))}hw.sub(
"onRenderComments",function(){setTimeout(w,f?1:360)}),n.addEventListener("resize",w,!1),n.addEventListener("orientationchange",w,!1);function g(){y&&(u.style.height=screen.height+"px",setTimeout(function(){n.scrollTo(0,0),u.style.height=n.innerHeight+"px"},1))}var y=void 0!==n.orientation;f||("complete"==r.readyState?g():n.addEventListener("load",g,!1),y&&(n.onorientationchange=g)),hw.news.options.disclosure=!f,hw.init()}(window);
